...
-------------------------------------
		 ASP.NET Integration
-------------------------------------
The Exceptionless.Web or Exceptionless.Mvc NuGet package will automatically 
configure your web.config. To start reporting unhandled exceptions in your 
application, add your Exceptionless api key to the web.config Exceptionless
section.
