    ...
    switch (state0) {
      ...
      case 2:
        ...
        if (t2 == null)
          ...
          actualParameters = $.toString(t1.sb_0);
          t1.sb_0 = $.StringBuffer$("");
          for (t3 = $.getInterceptor$JSArrayJSString(t2), i = 0; $.CONSTANT16.$lt(i, t3.get$length(t2)); ++i) {
            if (i > 0)
              $.add(t1.sb_0, ", ");
...
$$.ListQueue = {"": "Collection;_table>,_head,_tail,_modificationCount>",
  ...
  _grow$0: function() {
    ...
    t3 = this._head;
    split = t2 - t3;
    $.CONSTANT10.setRange$4(newTable, 0, split, t1, t3);
    $.CONSTANT10.setRange$4(newTable, split, this._head, this._table, 0);
    this._head = 0;
  ...
  _writeToList$1: function(target) {
    ...
    if (t1) {
      ...
      $.CONSTANT10.setRange$4(target, 0, $length, this._table, this._head);
      return $length;
    } else {
      t1 = this._table;
      firstPartSize = t1.length - t2;
      $.CONSTANT10.setRange$4(target, 0, firstPartSize, t1, t2);
      $.CONSTANT10.setRange$4(target, firstPartSize, this._tail, this._table, 0);
...
$$._ListQueueIterator = {"": "Object;_queue,_end,_modificationCount>,_liblib3$_position,_liblib3$_current",
  ...
  moveNext$0: function() {
    ...
    if ($.$$eq(this._liblib3$_position, this._end) === true) {
  ...
  moveNext$0$bailout: function(state0, t4, t1) {
    this._liblib3$_position = $.$$and($.$$add(t4, 1), t1._table.length - 1);
    return true;
  }
};
...
$$._NullKey = {"": "Object;",
  get$hashCode: function() {
    return $.CONSTANT13.get$hashCode(null);
  }
};
...
$$._HashTable = {"": "Object;_table>,_capacity,_entryCount,_deletedCount,_modificationCount>,_container",
  ...
  _isFree$1: function(marker) {
    return marker == null || marker === $.CONSTANT11;
  },
  _probeForAdd$2: function(hashCode, object) {
    ...
    for (firstTombstone = -1, probeCount = 0; true;) {
      ...
      } else if (($.CONSTANT12 === entry ? this._equals$2(null, object) : this._equals$2(entry, object)) === true)
        return offset;
      ++probeCount;
  ...
  _probeForLookup$2: function(hashCode, object) {
    ...
    for (probeCount = 0; true;) {
      ...
      if (entry == null)
        return -1;
      else if (!($.CONSTANT11 === entry))
        if (($.CONSTANT12 === entry ? this._equals$2(null, object) : this._equals$2(entry, object)) === true)
          return offset;
      ++probeCount;
      index = this._nextProbe$3(index, probeCount, this._capacity);
    }
  ...
  _addAllEntries$1$bailout: function(state0, oldTable) {
    ...
    i = 0;
    while ($.CONSTANT14.$lt(i, t1.get$length(oldTable))) {
      ...
      default:
        ...
        if (state0 === 2 || state0 === 0 && oldEntry == null)
          ...
          switch (state0) {
            case 0:
            case 3:
              if (state0 === 3 || state0 === 0 && oldEntry === $.CONSTANT11)
                switch (state0) {
                  case 0:
                    t1 = this._deletedCount;
                  case 3:
  ...
  _deleteEntry$1: function(offset) {
    this._setKey$2(offset, $.CONSTANT11);
...
$$._HashTableIterable = {"": "Iterable;",
  ...
  forEach$1$bailout1: function(state0, action, entrySize, t1, table) {
    ...
    offset = 0;
    while ($.CONSTANT14.$lt(offset, t2.get$length(table))) {
...
$$._HashTableIterator = {"": "Object;_modificationCount>",
  moveNext$0: function() {
    ...
    while (true) {
      ...
      if (!t1._isFree$1(entry)) {
        this._liblib3$_current = this._valueAt$2(t3, entry);
        return true;
      }
    }
    this._liblib3$_current = null;
...
$$._LinkedHashTable = {"": "_HashTable;",
  ...
  _put$1$bailout1: function(state0, key, offset, t1) {
    switch (state0) {
      ...
      default:
        var oldEntry;
        if (state0 === 2 || state0 === 0 && oldEntry === $.CONSTANT11)
          switch (state0) {
            case 0:
              t1 = this._deletedCount;
            case 2:
...
$$.ListIterator = {"": "Object;_iterable,_length,_index,_current",
  ...
  moveNext$0: function() {
    ...
    this._current = $.CONSTANT10.elementAt$1(t2, t3);
    t1 = this._index;
    if (typeof t1 !== "number")
  ...
  moveNext$0$bailout: function(state0, t3, t1, t2) {
    switch (state0) {
      ...
      case 1:
        ...
        this._current = $.CONSTANT10.elementAt$1(t2, this._index);
        t1 = this._index;
      case 2:
        state0 = 0;
  ...
  _deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      ...
      case 3:
        var id, i;
        state0 = 0;
        for (t1 = $.getInterceptor$JSArrayJSString(values), i = 0; $.CONSTANT16.$lt(i, len); ++i)
...
$$._StreamImpl = {"": "Stream;",
  ...
  get$_currentEventIdBit$bailout: function(state0, t1) {
    return $.CONSTANT14.$shr($.$$and(t1, 4), 2);
  },
...
$$._StreamSubscriptionImpl = {"": "_StreamListener;_unsubscribeOnError,_liblib$_onData,_onError,_onDone,_source,_state,_nextLink,_previousLink",
...
$$._StreamListener = {"": "_InternalLink;",
  ...
  _needsEvent$1$bailout: function(state0, currentEventIdBit, t1) {
    return !($.CONSTANT14.$shr($.$$and(t1, 4), 2) === currentEventIdBit);
  },
...
$$._DoneSubscription = {"": "Object;_handler>,_timer,_liblib$_pauseCount",
  _handler$0: function() {
  ...
  get$_isComplete: function() {
    return this._timer == null && this._liblib$_pauseCount === 0;
  },
  cancel$0: function() {
    if (this.get$_isComplete() === true)
...
$$._ElementCssClassSet = {"": "CssClassSet;_element",
  readClasses$0: function() {
    var s, t1, trimmed;
    s = $.HashSet$();
    for (t1 = $.CONSTANT10.get$iterator($.split(this._element.className, " ")); t1.moveNext$0() === true;) {
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib4$_element",
  readClasses$0: function() {
    ...
    if (classname == null)
      return s;
    for (t1 = $.CONSTANT10.get$iterator($.split(classname, " ")); t1.moveNext$0() === true;) {
      trimmed = $.trim(t1.get$current());
      if ($.CONSTANT9.get$isEmpty(trimmed) !== true)
        s.add$1(trimmed);
    }
...
$$.GalagaGame = {"": "Game;score=,highScore,lastPowerUp,lastEnemy,lastStar,_liblib0$_state,Stats>,Options>,Controls,Highscores>,RankSelect>,pointMultiplier=,enemyX<,enemyY<,bulletCap,shipStartLives,colorCount=,enemyCount,enemyAmount=,defaultTimer,level=,p1Dead<,goingRight>,_countdownTimer,_waitingTimer,_waiting=,difficulty=,bonusCheck=,bonusStage=,soundEffectsOn=,tutorial<,visualLevel>,ship>,nextId,targetId=,_statUpdateEvent>,_gameOverEvent>,_shipHitEvent>,_bossHitEvent>,_bossKilledEvent,_motherShipEvent>,_normalHitEvent>,entities,timer,clockTick,rect,sound,input,renderer,loop,bgStyle,showOutlines",
  ...
  set$state: function(value) {
    ...
    if ($.$$eq(this._liblib0$_state, 1) === true)
      this.enableEntitiesByGroup$1("welcome");
    else if ($.$$eq(this._liblib0$_state, 4) === true)
      this.enableEntitiesByGroup$1("gameOver");
    else if ($.$$eq(this._liblib0$_state, 5) === true)
      this.enableEntitiesByGroup$1("stats");
    else if ($.$$eq(this._liblib0$_state, 2) === true)
      this.enableEntitiesByGroup$1("paused");
    else if ($.$$eq(this._liblib0$_state, 6) === true)
      this.enableEntitiesByGroup$1("options");
    else if ($.$$eq(this._liblib0$_state, 7) === true)
      this.enableEntitiesByGroup$1("instructions");
    else if ($.$$eq(this._liblib0$_state, 8) === true)
      this.enableEntitiesByGroup$1("levelEnd");
    else if ($.$$eq(this._liblib0$_state, 9) === true)
  ...
  start$0: function() {
    ...
    if (t2.containsKey$1(9) !== true)
      $.$$indexSet(t2, 9, false);
    if ($.$$eq($.$$index(t1, "soundeffects"), 1) === true)
  ...
  update$0: function() {
    ...
    if (t1) {
      ...
      if (t1 <= 0) {
        ...
        this.visualLevel = t1 + 1;
      }
      t1 = this.get$state();
      if (typeof t1 !== "number")
        return this.update$0$bailout1(10, t1);
      if (t1 === 3) {
        t1 = $.$$index(this.Options, "soundeffects");
        if (typeof t1 !== "number")
      ...
      if (t1 <= 0 && this.bonusStage !== true)
        ...
        t3 = t2.$index(t1, "wins");
        if (typeof t3 !== "number")
          return this.update$0$bailout1(15, t1, t2, t3);
        t2.$indexSet(t1, "wins", t3 + 1);
    ...
    if (t1 < 7)
      ...
      this.colorCount = 1;
    $.forEach($.where(this.entities, new $.GalagaGame_update_anon5()), new $.GalagaGame_update_anon6(this));
    this.newStar$0();
  ...
  update$0$bailout1: function(state0, t1, t2, t3) {
    switch (state0) {
      ...
      case 1:
        state0 = 0;
      case 2:
        if (state0 === 2 || state0 === 0 && $.$$eq(t1, 3) !== true)
          switch (state0) {
            case 0:
              t1 = this.get$state();
            case 2:
          ...
          t1 = true;
      default:
        if (state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && t1)
          switch (state0) {
            case 0:
              t1 = this.input.keyCode;
            case 3:
              state0 = 0;
            case 4:
              if (state0 === 4 || state0 === 0 && $.$$eq(t1, 27) === true)
                switch (state0) {
                  case 0:
                    t1 = this.get$state();
                  case 4:
                    state0 = 0;
                    this.set$state($.$$eq(t1, 2) === true ? 3 : 2);
                }
              t1 = this.enemyAmount;
            case 5:
              state0 = 0;
            default:
              if (state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 0 && $.$$le(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.Stats;
                    t2 = $.getInterceptor$JSArrayJSString(t1);
                  ...
                  case 7:
                    state0 = 0;
                  case 8:
                    if (state0 === 8 || state0 === 0 && $.$$eq(t1, false) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.level;
                        case 8:
                  ...
                  case 9:
                    state0 = 0;
                    this.visualLevel = $.$$add(t1, 1);
                }
              t1 = this.get$state();
            case 10:
              state0 = 0;
            case 11:
              if (state0 === 11 || state0 === 0 && $.$$eq(t1, 3) === true)
                switch (state0) {
                  case 0:
                    t1 = $.$$index(this.Options, "soundeffects");
                  case 11:
            ...
            case 17:
            case 18:
              if (state0 === 0 && $.$$le(t1, 0) === true && this.bonusStage !== true)
                this.gameOver$0();
              else
                switch (state0) {
                  case 0:
                  case 14:
                    if (state0 === 14 || state0 === 0 && this.bonusStage === true)
                      switch (state0) {
                        case 0:
                          t1 = this.timer.get$gameTime();
                        case 14:
                      ...
                      t1 = false;
                  default:
                    if (state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 0 && t1)
                      switch (state0) {
                        case 0:
                          t1 = this.Stats;
                          t2 = $.getInterceptor$JSArrayJSString(t1);
                        ...
                        case 16:
                          state0 = 0;
                        case 17:
                          if (state0 === 17 || state0 === 0 && $.$$eq(t1, false) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.level;
                              case 17:
      ...
      case 20:
      case 21:
        if (state0 === 20 || state0 === 0 && $.$$lt(t1, 7) === true)
          switch (state0) {
            case 0:
              t1 = this.colorCount;
            case 20:
              state0 = 0;
              this.colorCount = $.$$add(t1, 1);
          }
        else
          switch (state0) {
            case 0:
  ...
  startStars$0: function() {
    ...
    do {
      t1 = this.rect.get$halfWidth();
      if (typeof t1 !== "number")
        return this.startStars$0$bailout(1, t1, star);
      star.set$x($.random(-t1, this.rect.get$halfWidth(), false));
      t3 = this.rect.get$halfHeight();
      if (typeof t3 !== "number")
        return this.startStars$0$bailout(2, 0, star, t3);
      star.set$y($.random(-t3, this.rect.get$halfHeight(), false));
    } while ($.any($.where(this.entities, new $.GalagaGame_startStars_anon()), new $.GalagaGame_startStars_anon0(star)) === true);
    this.addEntity$1(star);
  },
  startStars$0$bailout: function(state0, t1, star, t3) {
    switch (state0) {
      case 0:
        w = $.random(0.5, 3.5, false);
        star = $.Stars$(this, 0, 0, w, w, this.colorCount);
        ...
        L0:
          while (true)
            switch (state0) {
              ...
              case 1:
                state0 = 0;
                star.set$x($.random($.$$negate(t1), this.rect.get$halfWidth(), false));
                t3 = this.rect.get$halfHeight();
              case 2:
                state0 = 0;
                star.set$y($.random($.$$negate(t3), this.rect.get$halfHeight(), false));
                if (!($.any($.where(this.entities, new $.GalagaGame_startStars_anon()), new $.GalagaGame_startStars_anon0(star)) === true))
                  break L0;
            }
        this.addEntity$1(star);
    }
  ...
  newParticle$4: function(x, y, xVel, yVel) {
    var w = $.random(0.5, 3.5, false);
    this.addEntity$1($.Particles$(this, x, y, w, w, this.colorCount, xVel, yVel));
  },
  ...
  newStar$0: function() {
    var w, star;
    if ($.$$gt($.random(0, 1, false), 0.09) === true || $.$$eq(this.get$state(), 2) === true)
      return;
    w = $.random(0.5, 3.5, false);
    star = $.Stars$(this, 0, 0, w, w, this.colorCount);
    do {
      star.set$x($.random($.$$negate(this.rect.get$halfWidth()), this.rect.get$halfWidth(), false));
      star.set$y($.$$negate(this.rect.get$halfHeight()));
    } while ($.any($.where(this.entities, new $.GalagaGame_newStar_anon()), new $.GalagaGame_newStar_anon0(star)) === true);
  ...
  newBossDrone$2: function(x, y) {
    ...
    t1 = {};
    t1.x_0 = 0;
    $.forEach($.where(this.entities, new $.GalagaGame_newBossDrone_anon()), new $.GalagaGame_newBossDrone_anon0(t1));
    if ($.$$ge(t1.x_0, 6) === true)
      return;
    if ($.$$lt($.random(0, 1, false), 0.01) === true) {
  ...
  newMotherShip$1$difficulty: function(difficulty) {
    ...
    t1 = {};
    t1.x_0 = 0;
    $.forEach($.where(this.entities, new $.GalagaGame_newMotherShip_anon()), new $.GalagaGame_newMotherShip_anon0(t1));
    if ($.$$ge(t1.x_0, 2) === true)
      return;
    if ($.$$lt($.random(0, 1, false), 0.001) === true) {
      enemy = $.Enemy$(this, $.$$negate(this.rect.get$halfWidth()), -225, difficulty, "MotherShip");
      enemy.idNum = this.nextId;
      this.nextId = $.$$add(this.nextId, 1);
      this.addEntity$1(enemy);
    }
  ...
  newEnemy$1: function(difficulty) {
    ...
    t1 = this.enemyX;
    if (typeof t1 !== "number")
      return this.newEnemy$1$bailout(1, enemy, t1);
    this.enemyX = t1 + 70;
    t3 = this.enemyCount;
    if (typeof t3 !== "number")
      return this.newEnemy$1$bailout(2, enemy, 0, t3);
    this.enemyCount = t3 + 1;
    t1 = this.enemyCount;
    if (typeof t1 !== "number")
      return this.newEnemy$1$bailout(3, enemy, t1);
    if (t1 > 10) {
      t1 = this.enemyY;
      if (typeof t1 !== "number")
        return this.newEnemy$1$bailout(4, enemy, t1);
      this.enemyY = t1 + 65;
      this.enemyX = -400;
      this.enemyCount = 0;
    }
    ...
    t1 = this.nextId;
    if (typeof t1 !== "number")
      return this.newEnemy$1$bailout(5, enemy, t1);
    this.nextId = t1 + 1;
    this.lastEnemy = this.timer.get$gameTime();
    this.addEntity$1(enemy);
  },
  newEnemy$1$bailout: function(state0, enemy, t1, t3) {
    switch (state0) {
      case 0:
        enemy = $.Enemy$(this, this.enemyX, this.enemyY, difficulty, "Normal");
        enemy.startY = this.enemyY;
      ...
      case 3:
        state0 = 0;
      case 4:
        if (state0 === 4 || state0 === 0 && $.$$gt(t1, 10) === true)
          switch (state0) {
            case 0:
              t1 = this.enemyY;
            case 4:
  ...
  newBulletPowerUp$2: function(x, y) {
    this.addEntity$1($.PowerUp$(this, x, y, "bulletPower"));
  },
  newPowerUp$0: function() {
    if ($.$$ge($.random(0, 1, false), 0.1) === true)
      return;
    if ($.$$ge($.length($.where(this.entities, new $.GalagaGame_newPowerUp_anon())), 5) === true)
      return;
    if ($.$$lt(this.timer.get$gameTime(), 5) === true)
      return;
    if ($.$$ge($.$$add(this.lastPowerUp, 5), this.timer.get$gameTime()) === true)
      return;
    var powerUp = $.PowerUp$(this, 0, 0, null);
    do {
      powerUp.set$x($.random($.$$negate(this.rect.get$halfWidth()) + 50, $.$$sub(this.rect.get$halfWidth(), 50), false));
      powerUp.set$y($.$$negate(this.rect.get$halfHeight()));
    } while ($.any($.where(this.entities, new $.GalagaGame_newPowerUp_anon0()), new $.GalagaGame_newPowerUp_anon1(powerUp)) === true);
    this.lastPowerUp = this.timer.get$gameTime();
    this.addEntity$1(powerUp);
  },
  getEnemyX$1: function(type) {
    $.forEach($.where(this.entities, new $.GalagaGame_getEnemyX_anon()), new $.GalagaGame_getEnemyX_anon0(type));
    return 0;
  },
  getEnemyY$1: function(type) {
    $.forEach($.toList($.where(this.entities, new $.GalagaGame_getEnemyY_anon())), new $.GalagaGame_getEnemyY_anon0(type));
    return 0;
  },
  createLevelEnd$0: function() {
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "levelEnd", "", 0.4, 56, $.$$eq(this.visualLevel, this.bonusCheck) === true ? "Level " + $.S(this.visualLevel) + " Complete!" : "Prepare for Bonus Stage!", 0, -97));
    this.disableEntitiesByGroup$1("levelEnd");
  },
  createWelcomeMenu$0: function() {
    this._gameOverEvent.signal$0();
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", 0.4, 56, "Welcome to Galaga!", 0, -97));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createWelcomeMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", 0.4, 36, "Start Game", 0, -31));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createWelcomeMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", 0.4, 36, "Statistics", 0, 14));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createWelcomeMenu_anon1(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", 0.4, 36, "Options", 0, 48));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createWelcomeMenu_anon2(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", 0.4, 36, "Leaderboard", 0, 82));
    this.disableEntitiesByGroup$1("welcome");
  },
  createPausedMenu$0: function() {
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "paused", "", 0.4, 56, "PAUSED", 0, -31));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createPausedMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "paused", "", 0.4, 36, "Quit", 0, 15));
    this.disableEntitiesByGroup$1("paused");
  },
  createLeaderBoardMenu$0: function() {
    var t1, t2;
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 56, "Leaderboard", 0, -240));
    t1 = this.Highscores;
    t2 = $.getInterceptor$JSArrayJSString(t1);
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "1: " + $.S(t2.$index(t1, 1)), -145, -190));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "2: " + $.S(t2.$index(t1, 2)), -145, -150));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "3: " + $.S(t2.$index(t1, 3)), -145, -110));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "4: " + $.S(t2.$index(t1, 4)), -145, -70));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "5: " + $.S(t2.$index(t1, 5)), -145, -30));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "6: " + $.S(t2.$index(t1, 6)), -145, 10));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "7: " + $.S(t2.$index(t1, 7)), -145, 50));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "8: " + $.S(t2.$index(t1, 8)), -145, 90));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "9: " + $.S(t2.$index(t1, 9)), -145, 130));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 42, "10: " + $.S(t2.$index(t1, 10)), -145, 170));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createLeaderBoardMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.4, 36, "Back", -420, -280));
    this.disableEntitiesByGroup$1("leaders");
  },
  createStatsMenu$0: function() {
    var t1, t2;
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 56, "Statistics", 0, -280));
    t1 = this.Stats;
    t2 = $.getInterceptor$JSArrayJSString(t1);
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Total Killed: " + $.S(t2.$index(t1, "killed")), -400, -200));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Groupies Annihilated: " + $.S(t2.$index(t1, "normalKills")), -400, -155));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Big Bosses Denominated: " + $.S(t2.$index(t1, "bossKills")), -400, -110));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Mother Ships Deflowered: " + $.S(t2.$index(t1, "motherKills")), -400, -65));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Powerups Absorbed: " + $.S(t2.$index(t1, "powerups")), -400, -20));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Total Wins: " + $.S(t2.$index(t1, "wins")), -400, 25));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Total Loses: " + $.S(t2.$index(t1, "loses")), -400, 70));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Total Games: " + $.S(t2.$index(t1, "totalGames")), -400, 115));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "High Score: " + $.S(t2.$index(t1, "highscore")), -400, 160));
    t1 = this.RankSelect;
    t2 = $.getInterceptor$JSArrayJSString(t1);
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 1), true) === true ? 0.8 : 0.4, 36, "Jew", 100, -200));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 2), true) === true ? 0.8 : 0.4, 36, "Jewish Priest", 100, -155));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 3), true) === true ? 0.8 : 0.4, 36, "Amish Mastermind", 100, -110));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 4), true) === true ? 0.8 : 0.4, 36, "Road Warrior", 100, -65));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 5), true) === true ? 0.8 : 0.4, 36, "Space Recruit", 100, -20));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 6), true) === true ? 0.8 : 0.4, 36, "Space Cadet", 100, 25));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 7), true) === true ? 0.8 : 0.4, 36, "Space Captain", 100, 70));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 8), true) === true ? 0.8 : 0.4, 36, "Overlord of the Galaxy", 100, 115));
    this.addEntity$1($.GameText$(false, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", $.$$eq(t2.$index(t1, 9), true) === true ? 0.8 : 0.4, 36, "Overlord of the Universe", 100, 160));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createStatsMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "Back", -420, -280));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createStatsMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.4, 36, "RESET", 0, 225));
    this.disableEntitiesByGroup$1("stats");
  },
  createOptionsMenu$0: function() {
    var t1, t2, t3, t4, t5, t6;
    this._gameOverEvent.signal$0();
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.8, 56, "Options", 0, -160));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Starting Lives:", 0, -60));
    t1 = this.Options;
    t2 = $.getInterceptor$JSArrayJSString(t1);
    t3 = $.S(t2.$index(t1, "startLives"));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t3, 120, -60));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Bullet Cap:", 0, -30));
    t4 = $.S(t2.$index(t1, "bulletCap"));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t4, 120, -30));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Time:", 0, 0));
    t5 = $.S(t2.$index(t1, "time"));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon1(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t5, 120, 0));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Difficulty:", 0, 30));
    t6 = $.S(t2.$index(t1, "difficulty"));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon2(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t6, 120, 30));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Powerups Enabled:", -38, -94));
    t3 = $.$$eq(t2.$index(t1, "powerups"), 1) === true ? "True" : "False";
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon3(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t3, 150, -94));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Sound Effects Enabled:", -38, 60));
    t1 = $.$$eq(t2.$index(t1, "soundeffects"), 1) === true ? "True" : "False";
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon4(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, t1, 170, 60));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon5(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.6, 36, "Set to Defaults", 10, 120));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon6(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, "Instructions", 380, -280));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createOptionsMenu_anon7(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.4, 36, "Back", -420, -280));
    this.disableEntitiesByGroup$1("options");
  },
  createControlsMenu$0: function() {
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.8, 56, "Instructions", 0, -160));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Move left/right: Mouse swipe", 0, -94));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Fire: Left Mouse Button", 0, -45));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "'S' PowerUp = You shoot 3 shots in 3 different directions, which move in a spiral formation.", 0, 0));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "'x2' PowerUp = Multiplies your score additions by 2.", 0, 45));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "'+' PowerUp = Increases the amount of bullets you can fire by 1.", 0, 90));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "'Life' PowerUp = Increases your total lives by 1.", 0, 135));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createControlsMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.4, 36, "Back", 0, 180));
    this.disableEntitiesByGroup$1("instructions");
  },
  createGameOverMenu$0: function() {
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "gameOver", "", 0.4, 56, $.$$le(this.enemyAmount, 0) === true ? "You Won!" : "You Lost!", 0, -97));
    this.addEntity$1($.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "gameOver", "", 0.4, 36, "Play again?", 0, -31));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createGameOverMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "gameOver", "", 0.4, 36, "Yes", 0, 15));
    this.addEntity$1($.GameButton$(new $.GalagaGame_createGameOverMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "gameOver", "", 0.4, 36, "No", 0, 60));
    this.disableEntitiesByGroup$1("gameOver");
  },
  ...
  newGame$0: function() {
    var i, t1, t2, t3, t4;
    $.forEach($.where(this.entities, new $.GalagaGame_newGame_anon()), new $.GalagaGame_newGame_anon0());
    for (i = 0; i < 50; ++i) {
      if ($.$$lt(this.colorCount, 7) === true)
        this.colorCount = $.$$add(this.colorCount, 1);
      else if ($.$$ge(this.colorCount, 7) === true)
        this.colorCount = 1;
      this.startStars$0();
    }
    this.score = 0;
    ...
    if ($.$$ge(this.level, this.bonusCheck) === true) {
      this.bonusStage = true;
      this.bonusCheck = $.$$add(this.bonusCheck, 3);
    } else
      this.bonusStage = false;
    for (i = 0; i < 33; ++i)
      this.newEnemy$0();
    ...
    t4.$indexSet(t3, "totalGames", $.$$add(t4.$index(t3, "totalGames"), 1));
    this.set$state(3);
  ...
  gameOver$0: function() {
    ...
    t1 = this.Stats;
    t2 = $.getInterceptor$JSArrayJSString(t1);
    t2.$indexSet(t1, "loses", $.$$add(t2.$index(t1, "loses"), 1));
    this._gameOverEvent.signal$0();
    if (this.soundEffectsOn === true)
      this.sound.play$1("cursorSelect2");
  ...
  switchDirection$0: function() {
    ...
    $.forEach($.where(this.entities, new $.GalagaGame_switchDirection_anon()), new $.GalagaGame_switchDirection_anon0());
  },
  canEnemyFall$0: function() {
    var t1 = {};
    t1.x_0 = 0;
    $.forEach($.where(this.entities, new $.GalagaGame_canEnemyFall_anon()), new $.GalagaGame_canEnemyFall_anon0(t1));
    if ($.$$ge(t1.x_0, 3) === true)
      return false;
    else
      return true;
  ...
  updateLeaderboard$0: function() {
    ...
    if (typeof t1 !== "object" || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.$isJavaScriptIndexingBehavior())
      return this.updateLeaderboard$0$bailout(1, tempMap, t1);
    k = 1;
    for (; k < 11; ++k) {
      if (k >= t1.length)
        throw $.ioore(k);
    ...
    for (i = 1; i <= 10; ++i) {
      ...
      if ($.$$gt(t2, t1[i]) === true) {
        ...
        if (i >= t1.length)
          throw $.ioore(i);
        t1[i] = t2;
        $.$$indexSet(this.Stats, "highScore", t1[i]);
        break;
      }
    }
  },
  updateLeaderboard$0$bailout: function(state0, tempMap, t1) {
    var t3, k, i, j, t2;
    ...
    for (i = 1; i <= 10; ++i)
      if ($.$$gt(this.score, t3.$index(t1, i)) === true) {
        for (j = i + 1, t2 = $.getInterceptor$JSArray(t1); j < 10; ++j)
          t2.$indexSet(t1, j, tempMap.$index(j - 1));
        t2.$indexSet(t1, i, this.score);
        $.$$indexSet(this.Stats, "highScore", t3.$index(t1, i));
        break;
      }
  },
...
$$.Ship = {"": "GameEntity;bulletPower=,bullet=,maxBullet=,lives=,soundLevel,isPoweringUp,spiralShot=,superSpiral<,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if (t1 > t3) {
      t1 = this.game.get$rect().get$halfWidth();
      if (typeof t1 !== "number")
  ...
  update$0$bailout1: function(state0, t1, t2, t3) {
    switch (state0) {
      ...
      case 1:
        state0 = 0;
      default:
        if (state0 === 3 || state0 === 2 || state0 === 0 && $.$$eq(t1, 2) !== true)
          switch (state0) {
            case 0:
              t1 = this.game.get$state();
            case 2:
              state0 = 0;
            case 3:
              if (state0 === 3 || state0 === 0 && $.$$eq(t1, 4) !== true)
                switch (state0) {
                  case 0:
                    t1 = this.game.get$state();
                  case 3:
      ...
      case 4:
        state0 = 0;
      case 5:
        if (state0 === 5 || state0 === 0 && $.$$gt(t1, 36) !== true)
          switch (state0) {
            case 0:
              t1 = this.get$height();
            case 5:
      ...
      case 6:
        state0 = 0;
      case 7:
        if (state0 === 7 || state0 === 0 && $.$$le(t1, 0) === true)
          switch (state0) {
            case 0:
              t1 = this.game.get$Stats();
              t2 = $.getInterceptor$JSArrayJSString(t1);
      ...
      case 13:
        state0 = 0;
      case 14:
        if (state0 === 14 || state0 === 0 && $.$$gt(t1, t3) === true)
          switch (state0) {
            case 0:
              t1 = this.game.get$rect().get$halfWidth();
            case 14:
              state0 = 0;
              this.set$x($.$$sub(t1, 16));
          }
        t1 = this.get$x();
      case 15:
        state0 = 0;
      ...
      case 16:
        state0 = 0;
      case 17:
        if (state0 === 17 || state0 === 0 && $.$$lt(t1, $.$$negate(t3)) === true)
          switch (state0) {
            case 0:
              t1 = this.game.get$rect().get$halfWidth();
            case 17:
              state0 = 0;
              this.set$x($.$$negate(t1) + 16);
          }
        t1 = this.bullet;
      case 18:
        state0 = 0;
  ...
  fire$0: function() {
    var t1, t2;
    this.soundLevel = $.$$mul(this.bulletPower, 0.02);
    if ($.$$gt(this.soundLevel, 1) === true)
      this.soundLevel = 1;
    ...
    if ($.$$gt(this.bullet, 0) === true)
      this.bullet = $.$$sub(this.bullet, 1);
  },
  Ship$3: function(game, x, y) {
    this.opacity = 0.2;
    this.maxBullet = $.$$index(this.game.get$Options(), "bulletCap");
...
$$.Enemy = {"": "GameEntity;type=,yReset,isFalling>,creationTime,startY,difficulty=,bossDifficulty,health=,bossHealth,maxHp,bossMaxHp,belowHalfHp,idNum>,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if (t1 === "Drone") {
      ...
      if (t1 <= 0) {
        ...
        t1 = this.game.get$Stats();
        t5 = $.getInterceptor$JSArrayJSString(t1);
      ...
      if (typeof t3 !== "number")
        return this.update$0$bailout1(19, t1, t3);
      if (typeof t1 !== "number")
        return this.update$0$bailout1(18, t1);
      if (t1 > t3 - 80) {
        t1 = this.momentum;
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(20, t1, 0, t2);
        t1.set$yVel(t2 * -1);
      }
      t1 = this.get$y();
      t3 = this.game.get$rect().get$halfHeight();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(22, t1, t3);
      if (typeof t1 !== "number")
      ...
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(25, t1, t3);
      if (typeof t1 !== "number")
      ...
      if (t1 > t3 - 16) {
        ...
        t2 = t1.get$xVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(26, t1, 0, t2);
        t1.set$xVel(t2 * -1);
      }
      t1 = this.get$x();
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(28, t1, t3);
      if (typeof t1 !== "number")
      ...
      if (t1 < -t3 + 16) {
        ...
        t2 = t1.get$xVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(29, t1, 0, t2);
        t1.set$xVel(t2 * -1);
      }
      t1 = this.get$x();
      ...
      if (t1 > t3) {
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(31, t1);
        if (t1 <= 0.05) {
          t1 = this.momentum;
          t2 = t1.get$xVel();
          if (typeof t2 !== "number")
            return this.update$0$bailout1(32, t1, 0, t2);
          t1.set$xVel(t2 * -1);
        }
      }
      t1 = this.get$x();
      ...
      if (t1 < t3) {
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(34, t1);
        if (t1 <= 0.05) {
          t1 = this.momentum;
          t2 = t1.get$xVel();
          if (typeof t2 !== "number")
            return this.update$0$bailout1(35, t1, 0, t2);
          t1.set$xVel(t2 * -1);
        }
      }
      t1 = this.get$y();
      ...
      if (t1 > t3) {
        ...
        if (t1 <= 0.05) {
          ...
          t2 = t1.get$yVel();
          if (typeof t2 !== "number")
            return this.update$0$bailout1(38, t1, 0, t2);
          t1.set$yVel(t2 * -1);
        }
      }
      t1 = this.get$y();
      ...
      if (t1 < t3) {
        ...
        if (t1 <= 0.05) {
          ...
          t2 = t1.get$yVel();
          if (typeof t2 !== "number")
            return this.update$0$bailout1(41, t1, 0, t2);
          t1.set$yVel(t2 * -1);
        }
      }
      ...
      if (t1 === 1) {
        ...
        if (t1 <= 0.01) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(44, t1, t3, t2);
        ...
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(46, t1);
        if (t1 <= 0.03) {
          t1 = this.game;
          t2 = this.get$x();
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(47, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = this.game;
          if (t1.get$soundEffectsOn() === true)
            t1.get$sound().play$2("enemyFire", 0.3);
        ...
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(49, t1);
        if (t1 <= 0.07) {
          t1 = this.game;
          t2 = this.get$x();
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(50, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(51, t1);
          if (t1 <= 0.1) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(52, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(53, t1, 0, 0, t5, t6);
            ...
            if (t1 <= 0.1) {
              ...
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(56, t1, 0, 0, t5, t6);
        ...
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(58, t1);
        if (t1 <= 0.1) {
          t1 = this.game;
          t2 = this.get$x();
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(59, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(60, t1);
          if (t1 <= 0.3) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(61, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(62, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
            ...
            if (t1 <= 0.3) {
              ...
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(65, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
        ...
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(67, t1);
        if (t1 <= 0.2) {
          t1 = this.game;
          t2 = this.get$x();
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(68, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(69, t1);
          if (t1 <= 0.5) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(70, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(71, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
            ...
            if (t1 <= 0.5) {
              ...
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(74, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
    ...
    t1 = this.type;
    if (typeof t1 !== "string")
      return this.update$0$bailout1(75, t1);
    if (t1 === "Boss") {
      t1 = this.health;
      if (typeof t1 !== "number")
        return this.update$0$bailout1(76, t1);
      if (t1 <= 0) {
        t1 = this.game.get$Stats();
        t2 = $.getInterceptor$JSArrayJSString(t1);
        t3 = t2.$index(t1, "wins");
        if (typeof t3 !== "number")
          return this.update$0$bailout1(77, t1, t3, t2);
        t2.$indexSet(t1, "wins", t3 + 1);
        ...
        if (typeof t2 !== "number")
          return this.update$0$bailout1(79, t1, 0, t2);
        if (typeof t4 !== "number")
          return this.update$0$bailout1(80, 0, 0, t2, 0, 0, t4);
        if (t2 >= t4) {
          t1.set$bonusStage(true);
          t1 = this.game;
          t2 = t1.get$bonusCheck();
          if (typeof t2 !== "number")
            return this.update$0$bailout1(81, t1, 0, t2);
        ...
        if (typeof t4 !== "number")
          throw $.iae(t4);
        if (typeof t2 !== "number")
          return this.update$0$bailout1(82, t1, 0, t2);
        t1.set$score(t2 + 10000 * t4);
        t1 = this.game.get$Stats();
        t5 = $.getInterceptor$JSArrayJSString(t1);
        t6 = t5.$index(t1, "killed");
        if (typeof t6 !== "number")
          return this.update$0$bailout1(83, t1, 0, 0, t5, t6);
        t5.$indexSet(t1, "killed", t6 + 1);
        this.game.set$bonusStage(false);
        this.removeFromGame$0();
      }
      t1 = $.random(0, 1, false);
      if (typeof t1 !== "number")
        return this.update$0$bailout1(84, t1);
      if (t1 <= 0.01) {
        t1 = this.momentum;
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(85, t2);
        if (!(t2 === 0))
          t1.set$yVel(t2 * -1);
        else
          t1.set$yVel(60);
      ...
      if (t1 <= 0.01) {
        ...
        t2 = t1.get$xVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(88, t2);
        if (!(t2 === 0))
          t1.set$xVel(t2 * -1);
        else
          t1.set$xVel(60);
      ...
      t3 = this.game.get$rect().get$halfHeight();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(91, t1, t3);
      if (typeof t1 !== "number")
        return this.update$0$bailout1(90, t1);
      if (t1 > t3 - 250) {
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(92, t1);
        t1 = t1 <= 0.07;
      } else
        t1 = false;
      if (t1) {
        ...
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(93, t1, 0, t2);
        t1.set$yVel(t2 * -1);
      }
      t1 = this.get$y();
      t3 = this.game.get$rect().get$halfHeight();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(95, t1, t3);
      if (typeof t1 !== "number")
        return this.update$0$bailout1(94, t1);
      if (t1 > t3 - 115) {
        t1 = this.momentum;
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
      ...
      t3 = this.game.get$rect().get$halfHeight();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(98, t1, t3);
      if (typeof t1 !== "number")
      ...
      if (t1 < -t3 + 72) {
        ...
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(99, t1, 0, t2);
        t1.set$yVel(t2 * -1);
      }
      t1 = this.get$x();
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(101, t1, t3);
      if (typeof t1 !== "number")
      ...
      if (t1 > t3 - 72) {
        ...
        t2 = t1.get$xVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(102, t1, 0, t2);
        t1.set$xVel(t2 * -1);
      }
      t1 = this.get$x();
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(104, t1, t3);
      if (typeof t1 !== "number")
      ...
      if (t1 < -t3 + 72) {
        ...
        t2 = t1.get$xVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(105, t1, 0, t2);
        t1.set$xVel(t2 * -1);
      }
      if (this.belowHalfHp) {
        t1 = this.bossDifficulty;
        ...
        if (t1 === 1) {
          ...
          if (t1 <= 0.1) {
            ...
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(108, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(109, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(110, t1, 0, 0, 0, 0, 0, t8, t9);
          ...
          if (t1 <= 0.1) {
            ...
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(113, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(114, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(115, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
          ...
          if (t1 <= 0.2) {
            ...
            if (t1 <= 0.5) {
              ...
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(137, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(138, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t8 = this.get$x();
              t9 = this.get$y();
              if (typeof t9 !== "number")
                return this.update$0$bailout1(139, t1, 0, 0, 0, 0, 0, t8, t9);
              t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            } else {
              t1 = $.random(0, 1, false);
              if (typeof t1 !== "number")
              ...
              if (t1 <= 0.5) {
                ...
                t3 = this.get$y();
                if (typeof t3 !== "number")
                  return this.update$0$bailout1(141, t1, t3, t2);
                t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                t1 = this.game;
                t5 = this.get$x();
                t6 = this.get$y();
                if (typeof t6 !== "number")
                  return this.update$0$bailout1(142, t1, 0, 0, t5, t6);
                t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              }
            }
            t1 = this.game;
        ...
        t1 = this.bossDifficulty;
        if (typeof t1 !== "number")
          return this.update$0$bailout1(146, t1);
        if (t1 === 1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(147, t1);
          if (t1 <= 0.01) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(148, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(149, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(150, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
          ...
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(152, t1);
          if (t1 <= 0.03) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(153, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(154, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(155, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
          ...
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(157, t1);
          if (t1 <= 0.07) {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(158, t1);
            if (t1 <= 0.1) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(159, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(160, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t8 = this.get$x();
              t9 = this.get$y();
              if (typeof t9 !== "number")
                return this.update$0$bailout1(161, t1, 0, 0, 0, 0, 0, t8, t9);
              t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(42, 54, false), "normal"));
            } else {
              t1 = $.random(0, 1, false);
              if (typeof t1 !== "number")
                return this.update$0$bailout1(162, t1);
              if (t1 <= 0.1) {
                t1 = this.game;
                t2 = this.get$x();
                t3 = this.get$y();
                if (typeof t3 !== "number")
                  return this.update$0$bailout1(163, t1, t3, t2);
                t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                t1 = this.game;
                t5 = this.get$x();
                t6 = this.get$y();
                if (typeof t6 !== "number")
                  return this.update$0$bailout1(164, t1, 0, 0, t5, t6);
                t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              }
            }
            t1 = this.game;
            ...
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(165, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(166, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(167, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
          ...
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(169, t1);
          if (t1 <= 0.1) {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(170, t1);
            if (t1 <= 0.3) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(171, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(172, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t8 = this.get$x();
              t9 = this.get$y();
              if (typeof t9 !== "number")
                return this.update$0$bailout1(173, t1, 0, 0, 0, 0, 0, t8, t9);
              t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(42, 54, false), "normal"));
            } else {
              t1 = $.random(0, 1, false);
              if (typeof t1 !== "number")
                return this.update$0$bailout1(174, t1);
              if (t1 <= 0.3) {
                t1 = this.game;
                t2 = this.get$x();
                t3 = this.get$y();
                if (typeof t3 !== "number")
                  return this.update$0$bailout1(175, t1, t3, t2);
                t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                t1 = this.game;
                t5 = this.get$x();
                t6 = this.get$y();
                if (typeof t6 !== "number")
                  return this.update$0$bailout1(176, t1, 0, 0, t5, t6);
                t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              }
            }
            t1 = this.game;
            ...
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(177, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(178, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(179, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
          ...
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(181, t1);
          if (t1 <= 0.2) {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(182, t1);
            if (t1 <= 0.5) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(183, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(184, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(42, 54, false), "normal"));
              t1 = this.game;
              t8 = this.get$x();
              t9 = this.get$y();
              if (typeof t9 !== "number")
                return this.update$0$bailout1(185, t1, 0, 0, 0, 0, 0, t8, t9);
              t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(42, 54, false), "normal"));
            } else {
              t1 = $.random(0, 1, false);
              if (typeof t1 !== "number")
                return this.update$0$bailout1(186, t1);
              if (t1 <= 0.5) {
                t1 = this.game;
                t2 = this.get$x();
                t3 = this.get$y();
                if (typeof t3 !== "number")
                  return this.update$0$bailout1(187, t1, t3, t2);
                t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                t1 = this.game;
                t5 = this.get$x();
                t6 = this.get$y();
                if (typeof t6 !== "number")
                  return this.update$0$bailout1(188, t1, 0, 0, t5, t6);
                t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              }
            }
            t1 = this.game;
            ...
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(189, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(190, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            t8 = this.get$x();
            t9 = this.get$y();
            if (typeof t9 !== "number")
              return this.update$0$bailout1(191, t1, 0, 0, 0, 0, 0, t8, t9);
            t1.addEntity$1($.Bullet$(t1, t8, t9 + 16, "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
            t1 = this.game;
            if (t1.get$soundEffectsOn() === true)
              t1.get$sound().play$2("enemyFire", 0.3);
      ...
      if (t1 <= 0.5) {
        ...
        t2 = this.get$y();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(193, t1, t3, t2);
        t3.newBossDrone$2(t1, t2 - 50);
      } else {
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(194, t1, t3);
        t1 += 72;
        t4 = this.get$y();
        if (typeof t4 !== "number")
          return this.update$0$bailout1(195, t1, t3, 0, 0, 0, t4);
    ...
    if (t1 === "MotherShip") {
      ...
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t1 !== "number")
        return this.update$0$bailout1(197, t1);
      if (typeof t3 !== "number")
        return this.update$0$bailout1(198, t1, t3);
      if (t1 > t3)
        this.removeFromGame$0();
      t1 = this.health;
      if (typeof t1 !== "number")
        return this.update$0$bailout1(199, t1);
      if (t1 <= 0) {
        t1 = this.game;
        t2 = t1.get$score();
        t4 = t1.get$pointMultiplier();
        if (typeof t4 !== "number")
          throw $.iae(t4);
        if (typeof t2 !== "number")
          return this.update$0$bailout1(200, t1, 0, t2);
        t1.set$score(t2 + 1000 * t4);
        t1 = this.game.get$Stats();
        t5 = $.getInterceptor$JSArrayJSString(t1);
        t6 = t5.$index(t1, "killed");
        if (typeof t6 !== "number")
          return this.update$0$bailout1(201, t1, 0, 0, t5, t6);
        t5.$indexSet(t1, "killed", t6 + 1);
        t1 = $.random(0, 1, false);
        if (typeof t1 !== "number")
          return this.update$0$bailout1(202, t1);
        if (t1 > 0.5)
          this.game.newBulletPowerUp$2(this.get$x(), this.get$y());
        this.game.newMiniExplosion$2(this.get$x(), this.get$y());
        this.removeFromGame$0();
      ...
      if (t1 === 1) {
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(204, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(205, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(206, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(207, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        ...
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(209, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = this.game;
          if (t1.get$soundEffectsOn() === true)
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(211, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(212, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(213, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(214, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(215, t1);
          t1 = t1 <= 0.03;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(216, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = this.game;
          if (t1.get$soundEffectsOn() === true)
            t1.get$sound().play$2("motherShipFire", 0.3);
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(218, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(219, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(220, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(221, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(222, t1);
          t1 = t1 <= 0.07;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(223, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(224, t1);
          if (t1 <= 0.1) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(225, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(226, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(231, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(232, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(233, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(234, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(235, t1);
          t1 = t1 <= 0.1;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(236, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(237, t1);
          if (t1 <= 0.3) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(238, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(239, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(244, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(245, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
          ...
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(247, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        ...
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(249, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(250, t1);
          if (t1 <= 0.5) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(251, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(252, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
            ...
            if (t1 <= 0.5) {
              ...
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(254, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(255, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
    ...
    if (t1 === "Normal") {
      t1 = $.random(0, 1, false);
      if (typeof t1 !== "number")
        return this.update$0$bailout1(257, t1);
      if (t1 < 0.0002) {
      ...
      if (t1 <= 0) {
        ...
        if (typeof t5 !== "number")
          return this.update$0$bailout1(261, t1, 0, 0, t5);
        t1.set$enemyAmount(t5 - 1);
        t1 = this.game.get$Stats();
        t7 = $.getInterceptor$JSArrayJSString(t1);
        t8 = t7.$index(t1, "killed");
        if (typeof t8 !== "number")
          return this.update$0$bailout1(262, t1, 0, 0, 0, 0, 0, t8, 0, t7);
      ...
      t1 = this.get$y();
      if (typeof t1 !== "number")
        return this.update$0$bailout1(264, t1);
      ...
      if (t1 <= 0.01 && this.game.canEnemyFall$0()) {
        ...
        t2 = t1.get$yVel();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(268, t1, 0, t2);
        t1.set$yVel(t2 * -1);
        this.isFalling = true;
        this.yReset = false;
      }
      t1 = this.get$x();
      if (typeof t1 !== "number")
        return this.update$0$bailout1(269, t1);
      t1 += 16;
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(270, t1, t3);
      if (!(t1 > t3)) {
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(271, t1);
        t1 -= 16;
        t3 = this.game.get$rect().get$halfWidth();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(272, t1, t3);
        t1 = t1 < -t3;
      } else
        t1 = true;
      if (t1)
      ...
      if (this.collidesWith$1(this.game.get$ship())) {
        ...
        t2 = t1.get$lives();
        if (typeof t2 !== "number")
          return this.update$0$bailout1(273, t1, 0, t2);
        t1.set$lives(t2 - 1);
      }
      t1 = this.get$x();
      t3 = this.game.get$rect().get$halfWidth();
      if (typeof t3 !== "number")
        return this.update$0$bailout1(275, t1, t3);
      if (typeof t1 !== "number")
      ...
      t1 = this.difficulty;
      if (typeof t1 !== "number")
        return this.update$0$bailout1(276, t1);
      if (t1 === 1) {
        t1 = this.get$x();
        if (typeof t1 !== "number")
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(284, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(285, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
          ...
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(287, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(288, t1);
          t1 = t1 <= 0.03;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(289, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = this.game;
          if (t1.get$soundEffectsOn() === true)
            t1.get$sound().play$2("enemyFire", 0.3);
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(291, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(292, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(293, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(294, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(295, t1);
          t1 = t1 <= 0.07;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(296, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(297, t1);
          if (t1 <= 0.1) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(298, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(299, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(300, t1);
            if (t1 <= 0.1) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(301, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(302, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(304, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(305, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(306, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(307, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(308, t1);
          t1 = t1 <= 0.1;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(309, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(310, t1);
          if (t1 <= 0.3) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(311, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(312, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(313, t1);
            if (t1 <= 0.3) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(314, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(315, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
        ...
        t1 = this.get$x();
        if (typeof t1 !== "number")
          return this.update$0$bailout1(317, t1);
        t1 += 16;
        t3 = this.game.get$ship().get$x();
        if (typeof t3 !== "number")
          return this.update$0$bailout1(318, t1, t3);
        if (t1 >= t3) {
          t1 = this.get$x();
          if (typeof t1 !== "number")
            return this.update$0$bailout1(319, t1);
          t1 -= 16;
          t3 = this.game.get$ship().get$x();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(320, t1, t3);
          t3 = t1 <= t3;
          t1 = t3;
        } else
          t1 = false;
        if (t1) {
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(321, t1);
          t1 = t1 <= 0.2;
        } else
          t1 = false;
        if (t1) {
          ...
          t3 = this.get$y();
          if (typeof t3 !== "number")
            return this.update$0$bailout1(322, t1, t3, t2);
          t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          t1 = $.random(0, 1, false);
          if (typeof t1 !== "number")
            return this.update$0$bailout1(323, t1);
          if (t1 <= 0.5) {
            t1 = this.game;
            t2 = this.get$x();
            t3 = this.get$y();
            if (typeof t3 !== "number")
              return this.update$0$bailout1(324, t1, t3, t2);
            t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
            t1 = this.game;
            t5 = this.get$x();
            t6 = this.get$y();
            if (typeof t6 !== "number")
              return this.update$0$bailout1(325, t1, 0, 0, t5, t6);
            t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
          } else {
            t1 = $.random(0, 1, false);
            if (typeof t1 !== "number")
              return this.update$0$bailout1(326, t1);
            if (t1 <= 0.5) {
              t1 = this.game;
              t2 = this.get$x();
              t3 = this.get$y();
              if (typeof t3 !== "number")
                return this.update$0$bailout1(327, t1, t3, t2);
              t1.addEntity$1($.Bullet$(t1, t2, t3 + 16, "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
              t1 = this.game;
              t5 = this.get$x();
              t6 = this.get$y();
              if (typeof t6 !== "number")
                return this.update$0$bailout1(328, t1, 0, 0, t5, t6);
              t1.addEntity$1($.Bullet$(t1, t5, t6 + 16, "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
            }
          }
          t1 = this.game;
  ...
  update$0$bailout1: function(state0, t1, t3, t2, t5, t6, t4, t8, t9, t7) {
    switch (state0) {
      ...
      case 5:
        state0 = 0;
      case 6:
        if (state0 === 6 || state0 === 0 && $.$$lt(t1, $.$$div(t3, 2)) !== true)
          switch (state0) {
            case 0:
              t1 = this.bossHealth;
              t2 = this.bossMaxHp;
      ...
      case 73:
      case 74:
        if (state0 === 74 || state0 === 73 || state0 === 72 || state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 65 || state0 === 64 || state0 === 63 || state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 58 || state0 === 57 || state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 48 || state0 === 47 || state0 === 46 || state0 === 45 || state0 === 44 || state0 === 43 || state0 === 42 || state0 === 41 || state0 === 40 || state0 === 39 || state0 === 38 || state0 === 37 || state0 === 36 || state0 === 35 || state0 === 34 || state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 29 || state0 === 28 || state0 === 27 || state0 === 26 || state0 === 25 || state0 === 24 || state0 === 23 || state0 === 22 || state0 === 21 || state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 0 && $.$$eq(t1, "Drone") === true)
          switch (state0) {
            case 0:
              t1 = this.health;
            case 8:
              state0 = 0;
            default:
              if (state0 === 11 || state0 === 10 || state0 === 9 || state0 === 0 && $.$$le(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game;
                    t2 = t1.get$score();
                  case 9:
                    ...
                    if (typeof t4 !== "number")
                      throw $.iae(t4);
                    t1.set$score($.$$add(t2, 100 * t4));
                    t1 = this.game.get$Stats();
                    t5 = $.getInterceptor$JSArrayJSString(t1);
                    t6 = t5.$index(t1, "killed");
                  case 10:
                    state0 = 0;
                    t5.$indexSet(t1, "killed", $.$$add(t6, 1));
                    t1 = $.random(0, 1, false);
                  case 11:
                    state0 = 0;
                    if ($.$$gt(t1, 0.5) === true)
            ...
            case 13:
            case 14:
              if (state0 === 14 || state0 === 13 || state0 === 0 && $.$$le(t1, 0.01) === true)
                switch (state0) {
                  case 0:
            ...
            case 16:
            case 17:
              if (state0 === 17 || state0 === 16 || state0 === 0 && $.$$le(t1, 0.01) === true)
                switch (state0) {
                  case 0:
            ...
            case 19:
              state0 = 0;
            case 20:
              if (state0 === 20 || state0 === 0 && $.$$gt(t1, $.$$sub(t3, 80)) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$yVel();
            ...
            case 22:
              state0 = 0;
            case 23:
              if (state0 === 23 || state0 === 0 && $.$$lt(t1, $.$$negate(t3) + 16) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$yVel();
            ...
            case 25:
              state0 = 0;
            case 26:
              if (state0 === 26 || state0 === 0 && $.$$gt(t1, $.$$sub(t3, 16)) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$xVel();
            ...
            case 28:
              state0 = 0;
            case 29:
              if (state0 === 29 || state0 === 0 && $.$$lt(t1, $.$$negate(t3) + 16) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$xVel();
            ...
            case 31:
            case 32:
              if (state0 === 32 || state0 === 31 || state0 === 0 && $.$$gt(t1, this.game.getEnemyX$1("Boss")) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 31:
                    state0 = 0;
                  case 32:
                    if (state0 === 32 || state0 === 0 && $.$$le(t1, 0.05) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.momentum;
                          t2 = t1.get$xVel();
            ...
            case 34:
            case 35:
              if (state0 === 35 || state0 === 34 || state0 === 0 && $.$$lt(t1, this.game.getEnemyX$1("Boss")) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 34:
                    state0 = 0;
                  case 35:
                    if (state0 === 35 || state0 === 0 && $.$$le(t1, 0.05) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.momentum;
                          t2 = t1.get$xVel();
            ...
            case 37:
            case 38:
              if (state0 === 38 || state0 === 37 || state0 === 0 && $.$$gt(t1, this.game.getEnemyY$1("Boss")) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 37:
                    state0 = 0;
                  case 38:
                    if (state0 === 38 || state0 === 0 && $.$$le(t1, 0.05) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.momentum;
                          t2 = t1.get$yVel();
            ...
            case 40:
            case 41:
              if (state0 === 41 || state0 === 40 || state0 === 0 && $.$$lt(t1, this.game.getEnemyY$1("Boss")) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 40:
                    state0 = 0;
                  case 41:
                    if (state0 === 41 || state0 === 0 && $.$$le(t1, 0.05) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.momentum;
                          t2 = t1.get$yVel();
            ...
            case 73:
            case 74:
              if (state0 === 44 || state0 === 43 || state0 === 0 && $.$$eq(t1, 1) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 43:
                    state0 = 0;
                  case 44:
                    if (state0 === 44 || state0 === 0 && $.$$le(t1, 0.01) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.game;
                          t2 = this.get$x();
                        ...
                        case 44:
                          state0 = 0;
                          t1.addEntity$1($.Bullet$(t1, t2, $.$$add(t3, 16), "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
                          t1 = this.game;
                          if (t1.get$soundEffectsOn() === true)
                            t1.get$sound().play$2("enemyFire", 0.3);
                      }
                ...
                switch (state0) {
                  ...
                  case 45:
                    state0 = 0;
                  default:
                    if (state0 === 47 || state0 === 46 || state0 === 0 && $.$$eq(t1, 2) === true)
                      switch (state0) {
                        case 0:
                          t1 = $.random(0, 1, false);
                        case 46:
                          state0 = 0;
                        case 47:
                          if (state0 === 47 || state0 === 0 && $.$$le(t1, 0.03) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.game;
                                t2 = this.get$x();
                      ...
                      switch (state0) {
                        ...
                        case 48:
                          state0 = 0;
                        default:
                          if (state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 0 && $.$$eq(t1, 3) === true)
                            switch (state0) {
                              case 0:
                                t1 = $.random(0, 1, false);
                              case 49:
                                state0 = 0;
                              default:
                                if (state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 0 && $.$$le(t1, 0.07) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.game;
                                      t2 = this.get$x();
                                    ...
                                    case 51:
                                      state0 = 0;
                                    default:
                                      if (state0 === 53 || state0 === 52 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                          ...
                                          case 52:
                                            state0 = 0;
                                            t1.addEntity$1($.Bullet$(t1, t2, $.$$add(t3, 16), "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
                                            t1 = this.game;
                                            t5 = this.get$x();
                                            t6 = this.get$y();
                                          case 53:
                                            state0 = 0;
                                            t1.addEntity$1($.Bullet$(t1, t5, $.$$add(t6, 16), "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
                                        }
                                      else
                                        switch (state0) {
                                          case 0:
                                          ...
                                          case 54:
                                            state0 = 0;
                                          default:
                                            if (state0 === 56 || state0 === 55 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                                ...
                                                case 55:
                                                  state0 = 0;
                                                  t1.addEntity$1($.Bullet$(t1, t2, $.$$add(t3, 16), "left", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                                                  t1 = this.game;
                                                  t5 = this.get$x();
                                                  t6 = this.get$y();
                                                case 56:
                                                  state0 = 0;
                                                  t1.addEntity$1($.Bullet$(t1, t5, $.$$add(t6, 16), "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                                              }
                                        }
                                      t1 = this.game;
                                      if (t1.get$soundEffectsOn() === true)
                            ...
                            switch (state0) {
                              ...
                              case 57:
                                state0 = 0;
                              default:
                                if (state0 === 65 || state0 === 64 || state0 === 63 || state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 58 || state0 === 0 && $.$$eq(t1, 4) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = $.random(0, 1, false);
                                    case 58:
                                      state0 = 0;
                                    default:
                                      if (state0 === 65 || state0 === 64 || state0 === 63 || state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                          ...
                                          case 60:
                                            state0 = 0;
                                          default:
                                            if (state0 === 62 || state0 === 61 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                              ...
                                              switch (state0) {
                                                ...
                                                case 63:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 65 || state0 === 64 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                  ...
                                  switch (state0) {
                                    ...
                                    case 66:
                                      state0 = 0;
                                    default:
                                      if (state0 === 74 || state0 === 73 || state0 === 72 || state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 0 && $.$$eq(t1, 5) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = $.random(0, 1, false);
                                          case 67:
                                            state0 = 0;
                                          default:
                                            if (state0 === 74 || state0 === 73 || state0 === 72 || state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 0 && $.$$le(t1, 0.2) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                                ...
                                                case 69:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 71 || state0 === 70 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                                    ...
                                                    switch (state0) {
                                                      ...
                                                      case 72:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 74 || state0 === 73 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
        ...
        if (state0 === 195 || state0 === 194 || state0 === 193 || state0 === 192 || state0 === 191 || state0 === 190 || state0 === 189 || state0 === 188 || state0 === 187 || state0 === 186 || state0 === 185 || state0 === 184 || state0 === 183 || state0 === 182 || state0 === 181 || state0 === 180 || state0 === 179 || state0 === 178 || state0 === 177 || state0 === 176 || state0 === 175 || state0 === 174 || state0 === 173 || state0 === 172 || state0 === 171 || state0 === 170 || state0 === 169 || state0 === 168 || state0 === 167 || state0 === 166 || state0 === 165 || state0 === 164 || state0 === 163 || state0 === 162 || state0 === 161 || state0 === 160 || state0 === 159 || state0 === 158 || state0 === 157 || state0 === 156 || state0 === 155 || state0 === 154 || state0 === 153 || state0 === 152 || state0 === 151 || state0 === 150 || state0 === 149 || state0 === 148 || state0 === 147 || state0 === 146 || state0 === 145 || state0 === 144 || state0 === 143 || state0 === 142 || state0 === 141 || state0 === 140 || state0 === 139 || state0 === 138 || state0 === 137 || state0 === 136 || state0 === 135 || state0 === 134 || state0 === 133 || state0 === 132 || state0 === 131 || state0 === 130 || state0 === 129 || state0 === 128 || state0 === 127 || state0 === 126 || state0 === 125 || state0 === 124 || state0 === 123 || state0 === 122 || state0 === 121 || state0 === 120 || state0 === 119 || state0 === 118 || state0 === 117 || state0 === 116 || state0 === 115 || state0 === 114 || state0 === 113 || state0 === 112 || state0 === 111 || state0 === 110 || state0 === 109 || state0 === 108 || state0 === 107 || state0 === 106 || state0 === 105 || state0 === 104 || state0 === 103 || state0 === 102 || state0 === 101 || state0 === 100 || state0 === 99 || state0 === 98 || state0 === 97 || state0 === 96 || state0 === 95 || state0 === 94 || state0 === 93 || state0 === 92 || state0 === 91 || state0 === 90 || state0 === 89 || state0 === 88 || state0 === 87 || state0 === 86 || state0 === 85 || state0 === 84 || state0 === 83 || state0 === 82 || state0 === 81 || state0 === 80 || state0 === 79 || state0 === 78 || state0 === 77 || state0 === 76 || state0 === 0 && $.$$eq(t1, "Boss") === true)
          switch (state0) {
            ...
            case 76:
              state0 = 0;
            default:
              if (state0 === 83 || state0 === 82 || state0 === 81 || state0 === 80 || state0 === 79 || state0 === 78 || state0 === 77 || state0 === 0 && $.$$le(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game.get$Stats();
                    t2 = $.getInterceptor$JSArrayJSString(t1);
            ...
            case 85:
            case 86:
              if (state0 === 86 || state0 === 85 || state0 === 0 && $.$$le(t1, 0.01) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum.get$yVel();
                  case 85:
            ...
            case 88:
            case 89:
              if (state0 === 89 || state0 === 88 || state0 === 0 && $.$$le(t1, 0.01) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum.get$xVel();
                  case 88:
            ...
            case 91:
              state0 = 0;
            case 92:
              if (state0 === 92 || state0 === 0 && $.$$gt(t1, $.$$sub(t3, 250)) === true)
                switch (state0) {
                  case 0:
                    t1 = $.random(0, 1, false);
                  case 92:
            ...
            case 95:
              state0 = 0;
            case 96:
              if (state0 === 96 || state0 === 0 && $.$$gt(t1, $.$$sub(t3, 115)) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$yVel();
            ...
            case 98:
              state0 = 0;
            case 99:
              if (state0 === 99 || state0 === 0 && $.$$lt(t1, $.$$negate(t3) + 72) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$yVel();
            ...
            case 101:
              state0 = 0;
            case 102:
              if (state0 === 102 || state0 === 0 && $.$$gt(t1, $.$$sub(t3, 72)) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$xVel();
            ...
            case 104:
              state0 = 0;
            case 105:
              if (state0 === 105 || state0 === 0 && $.$$lt(t1, $.$$negate(t3) + 72) === true)
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$xVel();
            ...
            case 190:
            case 191:
              if (state0 === 145 || state0 === 144 || state0 === 143 || state0 === 142 || state0 === 141 || state0 === 140 || state0 === 139 || state0 === 138 || state0 === 137 || state0 === 136 || state0 === 135 || state0 === 134 || state0 === 133 || state0 === 132 || state0 === 131 || state0 === 130 || state0 === 129 || state0 === 128 || state0 === 127 || state0 === 126 || state0 === 125 || state0 === 124 || state0 === 123 || state0 === 122 || state0 === 121 || state0 === 120 || state0 === 119 || state0 === 118 || state0 === 117 || state0 === 116 || state0 === 115 || state0 === 114 || state0 === 113 || state0 === 112 || state0 === 111 || state0 === 110 || state0 === 109 || state0 === 108 || state0 === 107 || state0 === 106 || state0 === 0 && this.belowHalfHp)
                switch (state0) {
                  case 0:
                    t1 = this.bossDifficulty;
                  case 106:
                    state0 = 0;
                  default:
                    if (state0 === 110 || state0 === 109 || state0 === 108 || state0 === 107 || state0 === 0 && $.$$eq(t1, 1) === true)
                      switch (state0) {
                        case 0:
                          t1 = $.random(0, 1, false);
                        case 107:
                          state0 = 0;
                        default:
                          if (state0 === 110 || state0 === 109 || state0 === 108 || state0 === 0 && $.$$le(t1, 0.1) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.game;
                                t2 = this.get$x();
                              ...
                              case 109:
                                state0 = 0;
                                t1.addEntity$1($.Bullet$(t1, t5, $.$$add(t6, 16), "straight", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                                t1 = this.game;
                                t8 = this.get$x();
                                t9 = this.get$y();
                              case 110:
                                state0 = 0;
                                t1.addEntity$1($.Bullet$(t1, t8, $.$$add(t9, 16), "right", $.random(350, 400, false), $.random(8, 16, false), "exploding"));
                                t1 = this.game;
                                if (t1.get$soundEffectsOn() === true)
                                  t1.get$sound().play$2("enemyFire", 0.3);
                            }
                      ...
                      switch (state0) {
                        ...
                        case 111:
                          state0 = 0;
                        default:
                          if (state0 === 115 || state0 === 114 || state0 === 113 || state0 === 112 || state0 === 0 && $.$$eq(t1, 2) === true)
                            switch (state0) {
                              case 0:
                                t1 = $.random(0, 1, false);
                              case 112:
                                state0 = 0;
                              default:
                                if (state0 === 115 || state0 === 114 || state0 === 113 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.game;
                                      t2 = this.get$x();
                            ...
                            switch (state0) {
                              ...
                              case 116:
                                state0 = 0;
                              default:
                                if (state0 === 124 || state0 === 123 || state0 === 122 || state0 === 121 || state0 === 120 || state0 === 119 || state0 === 118 || state0 === 117 || state0 === 0 && $.$$eq(t1, 3) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = $.random(0, 1, false);
                                    case 117:
                                      state0 = 0;
                                    default:
                                      if (state0 === 124 || state0 === 123 || state0 === 122 || state0 === 121 || state0 === 120 || state0 === 119 || state0 === 118 || state0 === 0 && $.$$le(t1, 0.07) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = $.random(0, 1, false);
                                          case 118:
                                            state0 = 0;
                                          default:
                                            if (state0 === 121 || state0 === 120 || state0 === 119 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                              ...
                                              switch (state0) {
                                                ...
                                                case 122:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 124 || state0 === 123 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                  ...
                                  switch (state0) {
                                    ...
                                    case 125:
                                      state0 = 0;
                                    default:
                                      if (state0 === 133 || state0 === 132 || state0 === 131 || state0 === 130 || state0 === 129 || state0 === 128 || state0 === 127 || state0 === 126 || state0 === 0 && $.$$eq(t1, 4) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = $.random(0, 1, false);
                                          case 126:
                                            state0 = 0;
                                          default:
                                            if (state0 === 133 || state0 === 132 || state0 === 131 || state0 === 130 || state0 === 129 || state0 === 128 || state0 === 127 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = $.random(0, 1, false);
                                                case 127:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 130 || state0 === 129 || state0 === 128 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                                    ...
                                                    switch (state0) {
                                                      ...
                                                      case 131:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 133 || state0 === 132 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
                                        ...
                                        switch (state0) {
                                          ...
                                          case 134:
                                            state0 = 0;
                                          default:
                                            if (state0 === 145 || state0 === 144 || state0 === 143 || state0 === 142 || state0 === 141 || state0 === 140 || state0 === 139 || state0 === 138 || state0 === 137 || state0 === 136 || state0 === 135 || state0 === 0 && $.$$eq(t1, 5) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = $.random(0, 1, false);
                                                case 135:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 145 || state0 === 144 || state0 === 143 || state0 === 142 || state0 === 141 || state0 === 140 || state0 === 139 || state0 === 138 || state0 === 137 || state0 === 136 || state0 === 0 && $.$$le(t1, 0.2) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = $.random(0, 1, false);
                                                      case 136:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 139 || state0 === 138 || state0 === 137 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
                                                          ...
                                                          switch (state0) {
                                                            ...
                                                            case 140:
                                                              state0 = 0;
                                                            default:
                                                              if (state0 === 142 || state0 === 141 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                                switch (state0) {
                                                                  case 0:
                                                                    t1 = this.game;
                                                                    t2 = this.get$x();
                                                      ...
                                                      case 143:
                                                        state0 = 0;
                                                        t1.addEntity$1($.Bullet$(t1, t2, $.$$add(t3, 16), "straight", $.random(350, 400, false), $.random(30, 42, false), "normal"));
                                                        t1 = this.game;
                                                        t5 = this.get$x();
                                                        t6 = this.get$y();
                                                      case 144:
                                                        state0 = 0;
                                                        t1.addEntity$1($.Bullet$(t1, t5, $.$$add(t6, 16), "left", $.random(350, 400, false), $.random(30, 42, false), "normal"));
                                                        t1 = this.game;
                                                        t8 = this.get$x();
                                                        t9 = this.get$y();
                                                      case 145:
                                                        state0 = 0;
                                                        t1.addEntity$1($.Bullet$(t1, t8, $.$$add(t9, 16), "right", $.random(350, 400, false), $.random(30, 42, false), "normal"));
                                                        t1 = this.game;
                                                        if (t1.get$soundEffectsOn() === true)
                                                          t1.get$sound().play$2("enemyFire", 0.3);
                                                    }
                ...
                switch (state0) {
                  ...
                  case 146:
                    state0 = 0;
                  default:
                    if (state0 === 150 || state0 === 149 || state0 === 148 || state0 === 147 || state0 === 0 && $.$$eq(t1, 1) === true)
                      switch (state0) {
                        case 0:
                          t1 = $.random(0, 1, false);
                        case 147:
                          state0 = 0;
                        default:
                          if (state0 === 150 || state0 === 149 || state0 === 148 || state0 === 0 && $.$$le(t1, 0.01) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.game;
                                t2 = this.get$x();
                      ...
                      switch (state0) {
                        ...
                        case 151:
                          state0 = 0;
                        default:
                          if (state0 === 155 || state0 === 154 || state0 === 153 || state0 === 152 || state0 === 0 && $.$$eq(t1, 2) === true)
                            switch (state0) {
                              case 0:
                                t1 = $.random(0, 1, false);
                              case 152:
                                state0 = 0;
                              default:
                                if (state0 === 155 || state0 === 154 || state0 === 153 || state0 === 0 && $.$$le(t1, 0.03) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.game;
                                      t2 = this.get$x();
                            ...
                            switch (state0) {
                              ...
                              case 156:
                                state0 = 0;
                              default:
                                if (state0 === 167 || state0 === 166 || state0 === 165 || state0 === 164 || state0 === 163 || state0 === 162 || state0 === 161 || state0 === 160 || state0 === 159 || state0 === 158 || state0 === 157 || state0 === 0 && $.$$eq(t1, 3) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = $.random(0, 1, false);
                                    case 157:
                                      state0 = 0;
                                    default:
                                      if (state0 === 167 || state0 === 166 || state0 === 165 || state0 === 164 || state0 === 163 || state0 === 162 || state0 === 161 || state0 === 160 || state0 === 159 || state0 === 158 || state0 === 0 && $.$$le(t1, 0.07) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = $.random(0, 1, false);
                                          case 158:
                                            state0 = 0;
                                          default:
                                            if (state0 === 161 || state0 === 160 || state0 === 159 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                                ...
                                                case 159:
                                                  state0 = 0;
                                                  t1.addEntity$1($.Bullet$(t1, t2, $.$$add(t3, 16), "straight", $.random(350, 400, false), $.random(42, 54, false), "normal"));
                                                  t1 = this.game;
                                                  t5 = this.get$x();
                                                  t6 = this.get$y();
                                                case 160:
                                                  state0 = 0;
                                                  t1.addEntity$1($.Bullet$(t1, t5, $.$$add(t6, 16), "left", $.random(350, 400, false), $.random(42, 54, false), "normal"));
                                                  t1 = this.game;
                                                  t8 = this.get$x();
                                                  t9 = this.get$y();
                                                case 161:
                                                  state0 = 0;
                                                  t1.addEntity$1($.Bullet$(t1, t8, $.$$add(t9, 16), "right", $.random(350, 400, false), $.random(42, 54, false), "normal"));
                                              }
                                            else
                                              switch (state0) {
                                                case 0:
                                                ...
                                                case 162:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 164 || state0 === 163 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                  ...
                                  switch (state0) {
                                    ...
                                    case 168:
                                      state0 = 0;
                                    default:
                                      if (state0 === 179 || state0 === 178 || state0 === 177 || state0 === 176 || state0 === 175 || state0 === 174 || state0 === 173 || state0 === 172 || state0 === 171 || state0 === 170 || state0 === 169 || state0 === 0 && $.$$eq(t1, 4) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = $.random(0, 1, false);
                                          case 169:
                                            state0 = 0;
                                          default:
                                            if (state0 === 179 || state0 === 178 || state0 === 177 || state0 === 176 || state0 === 175 || state0 === 174 || state0 === 173 || state0 === 172 || state0 === 171 || state0 === 170 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = $.random(0, 1, false);
                                                case 170:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 173 || state0 === 172 || state0 === 171 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                                    ...
                                                    switch (state0) {
                                                      ...
                                                      case 174:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 176 || state0 === 175 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
                                        ...
                                        switch (state0) {
                                          ...
                                          case 180:
                                            state0 = 0;
                                          default:
                                            if (state0 === 191 || state0 === 190 || state0 === 189 || state0 === 188 || state0 === 187 || state0 === 186 || state0 === 185 || state0 === 184 || state0 === 183 || state0 === 182 || state0 === 181 || state0 === 0 && $.$$eq(t1, 5) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = $.random(0, 1, false);
                                                case 181:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 191 || state0 === 190 || state0 === 189 || state0 === 188 || state0 === 187 || state0 === 186 || state0 === 185 || state0 === 184 || state0 === 183 || state0 === 182 || state0 === 0 && $.$$le(t1, 0.2) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = $.random(0, 1, false);
                                                      case 182:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 185 || state0 === 184 || state0 === 183 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
                                                          ...
                                                          switch (state0) {
                                                            ...
                                                            case 186:
                                                              state0 = 0;
                                                            default:
                                                              if (state0 === 188 || state0 === 187 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                                switch (state0) {
                                                                  case 0:
                                                                    t1 = this.game;
                                                                    t2 = this.get$x();
            ...
            case 194:
            case 195:
              if (state0 === 193 || state0 === 0 && t1 === true)
                switch (state0) {
                  case 0:
                    t1 = this.get$x();
                    t2 = this.get$y();
                  case 193:
                    state0 = 0;
                    t3.newBossDrone$2(t1, $.$$sub(t2, 50));
                }
              else
                switch (state0) {
                  case 0:
                  ...
                  case 195:
                    state0 = 0;
                    t3.newBossDrone$2(t1, $.$$sub(t4, 50));
                }
          }
        t1 = this.type;
      case 196:
        ...
        if (state0 === 255 || state0 === 254 || state0 === 253 || state0 === 252 || state0 === 251 || state0 === 250 || state0 === 249 || state0 === 248 || state0 === 247 || state0 === 246 || state0 === 245 || state0 === 244 || state0 === 243 || state0 === 242 || state0 === 241 || state0 === 240 || state0 === 239 || state0 === 238 || state0 === 237 || state0 === 236 || state0 === 235 || state0 === 234 || state0 === 233 || state0 === 232 || state0 === 231 || state0 === 230 || state0 === 229 || state0 === 228 || state0 === 227 || state0 === 226 || state0 === 225 || state0 === 224 || state0 === 223 || state0 === 222 || state0 === 221 || state0 === 220 || state0 === 219 || state0 === 218 || state0 === 217 || state0 === 216 || state0 === 215 || state0 === 214 || state0 === 213 || state0 === 212 || state0 === 211 || state0 === 210 || state0 === 209 || state0 === 208 || state0 === 207 || state0 === 206 || state0 === 205 || state0 === 204 || state0 === 203 || state0 === 202 || state0 === 201 || state0 === 200 || state0 === 199 || state0 === 198 || state0 === 197 || state0 === 0 && $.$$eq(t1, "MotherShip") === true)
          switch (state0) {
            ...
            case 199:
              state0 = 0;
            default:
              if (state0 === 202 || state0 === 201 || state0 === 200 || state0 === 0 && $.$$le(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game;
                    t2 = t1.get$score();
            ...
            case 254:
            case 255:
              if (state0 === 209 || state0 === 208 || state0 === 207 || state0 === 206 || state0 === 205 || state0 === 204 || state0 === 0 && $.$$eq(t1, 1) === true)
                switch (state0) {
                  case 0:
                    t1 = this.get$x();
                  case 204:
                  ...
                  case 205:
                    state0 = 0;
                  default:
                    if (state0 === 207 || state0 === 206 || state0 === 0 && $.$$ge(t1, t3) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.get$x();
                        case 206:
                ...
                switch (state0) {
                  ...
                  case 210:
                    state0 = 0;
                  default:
                    if (state0 === 216 || state0 === 215 || state0 === 214 || state0 === 213 || state0 === 212 || state0 === 211 || state0 === 0 && $.$$eq(t1, 2) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.get$x();
                        case 211:
                        ...
                        case 212:
                          state0 = 0;
                        default:
                          if (state0 === 214 || state0 === 213 || state0 === 0 && $.$$ge(t1, t3) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.get$x();
                              case 213:
                      ...
                      switch (state0) {
                        ...
                        case 217:
                          state0 = 0;
                        default:
                          if (state0 === 229 || state0 === 228 || state0 === 227 || state0 === 226 || state0 === 225 || state0 === 224 || state0 === 223 || state0 === 222 || state0 === 221 || state0 === 220 || state0 === 219 || state0 === 218 || state0 === 0 && $.$$eq(t1, 3) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.get$x();
                              case 218:
                              ...
                              case 219:
                                state0 = 0;
                              default:
                                if (state0 === 221 || state0 === 220 || state0 === 0 && $.$$ge(t1, t3) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.get$x();
                                    case 220:
                              ...
                              case 228:
                              case 229:
                                if (state0 === 229 || state0 === 228 || state0 === 227 || state0 === 226 || state0 === 225 || state0 === 224 || state0 === 223 || state0 === 0 && t1)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.game;
                                      t2 = this.get$x();
                                    ...
                                    case 224:
                                      state0 = 0;
                                    default:
                                      if (state0 === 226 || state0 === 225 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                        ...
                                        switch (state0) {
                                          ...
                                          case 227:
                                            state0 = 0;
                                          default:
                                            if (state0 === 229 || state0 === 228 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                            ...
                            switch (state0) {
                              ...
                              case 230:
                                state0 = 0;
                              default:
                                if (state0 === 242 || state0 === 241 || state0 === 240 || state0 === 239 || state0 === 238 || state0 === 237 || state0 === 236 || state0 === 235 || state0 === 234 || state0 === 233 || state0 === 232 || state0 === 231 || state0 === 0 && $.$$eq(t1, 4) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.get$x();
                                    case 231:
                                    ...
                                    case 232:
                                      state0 = 0;
                                    default:
                                      if (state0 === 234 || state0 === 233 || state0 === 0 && $.$$ge(t1, t3) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.get$x();
                                          case 233:
                                    ...
                                    case 241:
                                    case 242:
                                      if (state0 === 242 || state0 === 241 || state0 === 240 || state0 === 239 || state0 === 238 || state0 === 237 || state0 === 236 || state0 === 0 && t1)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                          ...
                                          case 237:
                                            state0 = 0;
                                          default:
                                            if (state0 === 239 || state0 === 238 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                              ...
                                              switch (state0) {
                                                ...
                                                case 240:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 242 || state0 === 241 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                  ...
                                  switch (state0) {
                                    ...
                                    case 243:
                                      state0 = 0;
                                    default:
                                      if (state0 === 255 || state0 === 254 || state0 === 253 || state0 === 252 || state0 === 251 || state0 === 250 || state0 === 249 || state0 === 248 || state0 === 247 || state0 === 246 || state0 === 245 || state0 === 244 || state0 === 0 && $.$$eq(t1, 5) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.get$x();
                                          case 244:
                                          ...
                                          case 245:
                                            state0 = 0;
                                          default:
                                            if (state0 === 247 || state0 === 246 || state0 === 0 && $.$$ge(t1, t3) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.get$x();
                                                case 246:
                                          ...
                                          case 254:
                                          case 255:
                                            if (state0 === 255 || state0 === 254 || state0 === 253 || state0 === 252 || state0 === 251 || state0 === 250 || state0 === 249 || state0 === 0 && t1)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                                ...
                                                case 250:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 252 || state0 === 251 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                                    ...
                                                    switch (state0) {
                                                      ...
                                                      case 253:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 255 || state0 === 254 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
        ...
        if (state0 === 328 || state0 === 327 || state0 === 326 || state0 === 325 || state0 === 324 || state0 === 323 || state0 === 322 || state0 === 321 || state0 === 320 || state0 === 319 || state0 === 318 || state0 === 317 || state0 === 316 || state0 === 315 || state0 === 314 || state0 === 313 || state0 === 312 || state0 === 311 || state0 === 310 || state0 === 309 || state0 === 308 || state0 === 307 || state0 === 306 || state0 === 305 || state0 === 304 || state0 === 303 || state0 === 302 || state0 === 301 || state0 === 300 || state0 === 299 || state0 === 298 || state0 === 297 || state0 === 296 || state0 === 295 || state0 === 294 || state0 === 293 || state0 === 292 || state0 === 291 || state0 === 290 || state0 === 289 || state0 === 288 || state0 === 287 || state0 === 286 || state0 === 285 || state0 === 284 || state0 === 283 || state0 === 282 || state0 === 281 || state0 === 280 || state0 === 279 || state0 === 278 || state0 === 277 || state0 === 276 || state0 === 275 || state0 === 274 || state0 === 273 || state0 === 272 || state0 === 271 || state0 === 270 || state0 === 269 || state0 === 268 || state0 === 267 || state0 === 266 || state0 === 265 || state0 === 264 || state0 === 263 || state0 === 262 || state0 === 261 || state0 === 260 || state0 === 259 || state0 === 258 || state0 === 257 || state0 === 0 && $.$$eq(t1, "Normal") === true)
          switch (state0) {
            ...
            case 257:
              state0 = 0;
            case 258:
              if (state0 === 258 || state0 === 0 && $.$$lt(t1, 0.0002) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game.get$canEnemyFall();
                  case 258:
            ...
            case 259:
              state0 = 0;
            default:
              if (state0 === 263 || state0 === 262 || state0 === 261 || state0 === 260 || state0 === 0 && $.$$le(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game;
                    t2 = t1.get$score();
                  ...
                  case 261:
                    state0 = 0;
                    t1.set$enemyAmount($.$$sub(t5, 1));
                    t1 = this.game.get$Stats();
                    t7 = $.getInterceptor$JSArrayJSString(t1);
                    t8 = t7.$index(t1, "killed");
                  case 262:
                    state0 = 0;
                    t7.$indexSet(t1, "killed", $.$$add(t8, 1));
                    t1 = $.random(0, 1, false);
                  case 263:
                    state0 = 0;
                    if ($.$$gt(t1, 0.5) === true)
            ...
            case 267:
              state0 = 0;
            case 268:
              if (state0 === 268 || state0 === 0 && $.$$le(t1, 0.01) === true && this.game.canEnemyFall$0())
                switch (state0) {
                  case 0:
                    t1 = this.momentum;
                    t2 = t1.get$yVel();
            ...
            case 271:
            case 272:
              if (state0 === 272 || state0 === 271 || state0 === 0 && $.$$gt(t1, t3) !== true)
                switch (state0) {
                  case 0:
                    t1 = this.get$x();
                  case 271:
              ...
              if (t1)
                this.game.switchDirection$0();
            case 273:
              if (state0 === 273 || state0 === 0 && this.collidesWith$1(this.game.get$ship()))
                switch (state0) {
                  case 0:
                    this.game.get$_gameOverEvent().signal$0();
                    t1 = this.game;
            ...
            case 327:
            case 328:
              if (state0 === 282 || state0 === 281 || state0 === 280 || state0 === 279 || state0 === 278 || state0 === 277 || state0 === 0 && $.$$eq(t1, 1) === true)
                switch (state0) {
                  case 0:
                    t1 = this.get$x();
                  case 277:
                  ...
                  case 278:
                    state0 = 0;
                  default:
                    if (state0 === 280 || state0 === 279 || state0 === 0 && $.$$ge(t1, t3) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.get$x();
                        case 279:
                ...
                switch (state0) {
                  ...
                  case 283:
                    state0 = 0;
                  default:
                    if (state0 === 289 || state0 === 288 || state0 === 287 || state0 === 286 || state0 === 285 || state0 === 284 || state0 === 0 && $.$$eq(t1, 2) === true)
                      switch (state0) {
                        case 0:
                          t1 = this.get$x();
                        case 284:
                        ...
                        case 285:
                          state0 = 0;
                        default:
                          if (state0 === 287 || state0 === 286 || state0 === 0 && $.$$ge(t1, t3) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.get$x();
                              case 286:
                      ...
                      switch (state0) {
                        ...
                        case 290:
                          state0 = 0;
                        default:
                          if (state0 === 302 || state0 === 301 || state0 === 300 || state0 === 299 || state0 === 298 || state0 === 297 || state0 === 296 || state0 === 295 || state0 === 294 || state0 === 293 || state0 === 292 || state0 === 291 || state0 === 0 && $.$$eq(t1, 3) === true)
                            switch (state0) {
                              case 0:
                                t1 = this.get$x();
                              case 291:
                              ...
                              case 292:
                                state0 = 0;
                              default:
                                if (state0 === 294 || state0 === 293 || state0 === 0 && $.$$ge(t1, t3) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.get$x();
                                    case 293:
                              ...
                              case 301:
                              case 302:
                                if (state0 === 302 || state0 === 301 || state0 === 300 || state0 === 299 || state0 === 298 || state0 === 297 || state0 === 296 || state0 === 0 && t1)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.game;
                                      t2 = this.get$x();
                                    ...
                                    case 297:
                                      state0 = 0;
                                    default:
                                      if (state0 === 299 || state0 === 298 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                        ...
                                        switch (state0) {
                                          ...
                                          case 300:
                                            state0 = 0;
                                          default:
                                            if (state0 === 302 || state0 === 301 || state0 === 0 && $.$$le(t1, 0.1) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                            ...
                            switch (state0) {
                              ...
                              case 303:
                                state0 = 0;
                              default:
                                if (state0 === 315 || state0 === 314 || state0 === 313 || state0 === 312 || state0 === 311 || state0 === 310 || state0 === 309 || state0 === 308 || state0 === 307 || state0 === 306 || state0 === 305 || state0 === 304 || state0 === 0 && $.$$eq(t1, 4) === true)
                                  switch (state0) {
                                    case 0:
                                      t1 = this.get$x();
                                    case 304:
                                    ...
                                    case 305:
                                      state0 = 0;
                                    default:
                                      if (state0 === 307 || state0 === 306 || state0 === 0 && $.$$ge(t1, t3) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.get$x();
                                          case 306:
                                    ...
                                    case 314:
                                    case 315:
                                      if (state0 === 315 || state0 === 314 || state0 === 313 || state0 === 312 || state0 === 311 || state0 === 310 || state0 === 309 || state0 === 0 && t1)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.game;
                                            t2 = this.get$x();
                                          ...
                                          case 310:
                                            state0 = 0;
                                          default:
                                            if (state0 === 312 || state0 === 311 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                              ...
                                              switch (state0) {
                                                ...
                                                case 313:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 315 || state0 === 314 || state0 === 0 && $.$$le(t1, 0.3) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                  ...
                                  switch (state0) {
                                    ...
                                    case 316:
                                      state0 = 0;
                                    default:
                                      if (state0 === 328 || state0 === 327 || state0 === 326 || state0 === 325 || state0 === 324 || state0 === 323 || state0 === 322 || state0 === 321 || state0 === 320 || state0 === 319 || state0 === 318 || state0 === 317 || state0 === 0 && $.$$eq(t1, 5) === true)
                                        switch (state0) {
                                          case 0:
                                            t1 = this.get$x();
                                          case 317:
                                          ...
                                          case 318:
                                            state0 = 0;
                                          default:
                                            if (state0 === 320 || state0 === 319 || state0 === 0 && $.$$ge(t1, t3) === true)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.get$x();
                                                case 319:
                                          ...
                                          case 327:
                                          case 328:
                                            if (state0 === 328 || state0 === 327 || state0 === 326 || state0 === 325 || state0 === 324 || state0 === 323 || state0 === 322 || state0 === 0 && t1)
                                              switch (state0) {
                                                case 0:
                                                  t1 = this.game;
                                                  t2 = this.get$x();
                                                ...
                                                case 323:
                                                  state0 = 0;
                                                default:
                                                  if (state0 === 325 || state0 === 324 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                    switch (state0) {
                                                      case 0:
                                                        t1 = this.game;
                                                        t2 = this.get$x();
                                                    ...
                                                    switch (state0) {
                                                      ...
                                                      case 326:
                                                        state0 = 0;
                                                      default:
                                                        if (state0 === 328 || state0 === 327 || state0 === 0 && $.$$le(t1, 0.5) === true)
                                                          switch (state0) {
                                                            case 0:
                                                              t1 = this.game;
                                                              t2 = this.get$x();
  ...
  Enemy$5: function(game, x, y, diff, Type) {
    ...
    if ($.$$eq(this.type, "Normal") === true)
      this.color = "255, 0, 255";
    if ($.$$eq(this.type, "MotherShip") === true)
      this.color = "0, 0, 255";
    if ($.$$eq(this.type, "Normal") === true)
      this.momentum.set$xVel(80);
    if ($.$$eq(this.type, "MotherShip") === true)
      this.momentum.set$xVel(40);
    if ($.$$eq(this.type, "Boss") === true)
      this.momentum.set$xVel(0);
    if ($.$$eq(this.type, "Drone") === true)
      this.momentum.set$xVel(80);
    if ($.$$eq(this.type, "Normal") === true)
    ...
    this.bossDifficulty = $.$$div(game.get$level(), 3);
    this.startY = y;
  },
  $isEnemy: true
};
...
$$.PowerUp = {"": "GameEntity;type=,creationTime,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    var t1, t2;
    if ($.$$eq(this.game.get$state(), 2) === true || $.$$eq(this.game.get$state(), 4) === true || $.$$eq(this.game.get$state(), 1) === true)
      return;
    if ($.$$eq(this.type, "bulletPower") === true) {
      t1 = $.$$gt(this.game.get$ship().get$x(), this.get$x());
      t2 = this.momentum;
      if (t1 === true)
        t2.set$xVel(40);
      else
    ...
    if (this.collidesWith$1(this.game.get$ship())) {
      switch (this.type) {
        ...
        case "Multiplier":
          t1 = this.game;
          t1.set$pointMultiplier($.$$mul(t1.get$pointMultiplier(), 2));
          break;
        case "BulletIncrease":
          t1 = this.game.get$ship();
          t1.set$maxBullet($.$$add(t1.get$maxBullet(), 1));
          break;
        case "ExtraLife":
          t1 = this.game.get$ship();
          t1.set$lives($.$$add(t1.get$lives(), 1));
          break;
        case "bulletPower":
          t1 = this.game.get$ship();
          t1.set$bulletPower($.$$add(t1.get$bulletPower(), 1));
          break;
      }
      t1 = this.game;
      if (t1.get$soundEffectsOn() === true)
    ...
    if ($.$$gt(this.get$y(), $.$$add(this.game.get$rect().get$halfHeight(), 20)) === true)
      this.removeFromGame$0();
    $.GameEntity.prototype.update$0.call(this);
  },
  ...
  PowerUp$4: function(game, x, y, Type) {
    ...
    this.creationTime = game.get$timer().get$gameTime();
    t1 = $.getInterceptor$JSNumber(rType);
    ...
    if (!(Type == null)) {
      ...
      if ($.$$eq(this.type, "bulletPower") === true) {
        ...
        t1 = $.getInterceptor$JSNumber(rColor);
...
$$.Bullet = {"": "GameEntity;temp,startX,Type,_deleteTimer,_waiting=,farRight,farLeft,right=,left=,straight,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    t3 = this.game.get$rect().get$halfHeight();
    if (typeof t3 !== "number")
      return this.update$0$bailout1(22, t1, 0, t3);
    if (typeof t1 !== "number")
      return this.update$0$bailout1(21, t1);
    if (t1 < -t3) {
      t1 = this.game.get$ship();
      t2 = t1.get$bullet();
      if (typeof t2 !== "number")
        return this.update$0$bailout1(23, t2);
      if (t2 < 3)
        t1.set$bullet(t2 + 1);
      this.removeFromGame$0();
    }
    ...
    if (!(t1 === 0))
      $.forEach($.toList($.where(this.game.get$entities(), new $.Bullet_update_anon0(this))), new $.Bullet_update_anon1(this));
    t1 = this.momentum.get$yVel();
    if (typeof t1 !== "number")
      return this.update$0$bailout1(26, t1);
    if (t1 < 0)
      $.forEach($.toList($.where(this.game.get$entities(), new $.Bullet_update_anon2(this))), new $.Bullet_update_anon3(this));
    t1 = this.momentum.get$yVel();
    if (typeof t1 !== "number")
      return this.update$0$bailout1(27, t1);
    if (t1 > 0)
      $.forEach($.toList($.where(this.game.get$entities(), new $.Bullet_update_anon4(this))), new $.Bullet_update_anon5(this));
  },
  update$0$bailout1: function(state0, t1, t2, t3, t5) {
    switch (state0) {
      ...
      case 5:
        state0 = 0;
      case 6:
        if (state0 === 6 || state0 === 0 && $.$$le(t1, 0) !== true)
          switch (state0) {
            case 0:
              t1 = this.get$height();
            case 6:
        ...
        if (state0 === 8 || state0 === 7 || state0 === 0 && t1)
          switch (state0) {
            ...
            case 7:
              state0 = 0;
            case 8:
              if (state0 === 8 || state0 === 0 && $.$$gt(t1, 0) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game;
                    t2 = t1.get$score();
            ...
            default:
              if (state0 === 11 || state0 === 10 || state0 === 9 || state0 === 0 && this.right === true)
                switch (state0) {
                  ...
                  case 11:
                    state0 = 0;
                    t7 = $.$$lt(t1, $.$$sub($.$$sub(t3, $.$$div(t5, 2)), 25)) === true;
                    t1 = t7;
                }
              else
                t1 = false;
                  ...
                  default:
                    if (state0 === 14 || state0 === 13 || state0 === 12 || state0 === 0 && this.left === true)
                      switch (state0) {
                        ...
                        case 14:
                          state0 = 0;
                          t7 = $.$$gt(t1, $.$$add($.$$add(t3, $.$$div(t5, 2)), 25)) === true;
                          t1 = t7;
                      }
                    else
                      t1 = false;
                        ...
                        default:
                          if (state0 === 17 || state0 === 16 || state0 === 15 || state0 === 0 && this.farLeft === true)
                            switch (state0) {
                              ...
                              case 17:
                                state0 = 0;
                                t7 = $.$$gt(t1, $.$$add($.$$add(t3, $.$$div(t5, 2)), 40)) === true;
                                t1 = t7;
                            }
                          else
                            t1 = false;
      ...
      case 23:
      case 24:
        if (state0 === 24 || state0 === 23 || state0 === 0 && $.$$lt(t1, $.$$negate(t3)) === true)
          switch (state0) {
            case 0:
            ...
            case 23:
              state0 = 0;
            case 24:
              if (state0 === 24 || state0 === 0 && $.$$lt(t1, 3) === true)
                switch (state0) {
                  case 0:
                    t1 = this.game.get$ship();
                    t2 = t1.get$bullet();
...
$$.Stars = {"": "GameEntity;game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if (typeof t1 !== "number")
      return this.update$0$bailout1(2, t1);
    if (typeof t3 !== "number")
      return this.update$0$bailout1(3, t1, t3);
    if (t1 > t3)
      this.removeFromGame$0();
    $.GameEntity.prototype.update$0.call(this);
  },
  update$0$bailout1: function(state0, t1, t3) {
    switch (state0) {
      case 0:
        t1 = this.game.get$state();
      case 1:
...
$$.Particles = {"": "GameEntity;_deleteTimer,_waiting=,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if (typeof t1 !== "number")
      return this.update$0$bailout1(6, t1);
    if (typeof t3 !== "number")
      return this.update$0$bailout1(7, t1, t3);
    if (t1 > t3)
      this.removeFromGame$0();
    t1 = this.get$x();
    t3 = this.game.get$rect().get$halfWidth();
    if (typeof t3 !== "number")
      return this.update$0$bailout1(9, t1, t3);
    if (typeof t1 !== "number")
      return this.update$0$bailout1(8, t1);
    if (t1 < -t3)
      this.removeFromGame$0();
...
$$.Game = {"": "Object;entities>,timer>,clockTick=,rect>,sound>,input>,renderer>,loop<,bgStyle=,showOutlines>",
  ...
  enableEntitiesByGroup$1: function(groupId) {
    $.forEach($.where(this.entities, new $.Game_enableEntitiesByGroup_anon(groupId)), new $.Game_enableEntitiesByGroup_anon0());
  },
  disableEntitiesByGroup$1: function(groupId) {
    $.forEach($.where(this.entities, new $.Game_disableEntitiesByGroup_anon(groupId)), new $.Game_disableEntitiesByGroup_anon0());
  },
  removeEntitiesByGroup$1: function(groupId) {
    $.forEach($.toList($.where(this.entities, new $.Game_removeEntitiesByGroup_anon(groupId))), new $.Game_removeEntitiesByGroup_anon0());
  },
  removeEntitiesByFilter$1: function(f) {
    $.forEach($.toList($.where(this.entities, new $.Game_removeEntitiesByFilter_anon(f))), new $.Game_removeEntitiesByFilter_anon0());
  },
  update$0: function() {
    var t1, i;
    $.length(this.entities);
    for (t1 = $.iterator($.toList($.where(this.entities, new $.Game_update_anon()))); t1.moveNext$0() === true;)
      t1.get$current().update$0();
    t1 = $.length(this.entities);
    if (typeof t1 !== "number")
        ...
        L0:
          while (true)
            switch (state0) {
              ...
              case 2:
                state0 = 0;
                if ($.$$index(t2, i).get$_removeFromGame() === true)
                  $.removeRange(this.entities, i, 1);
                i = t1.$sub(i, 1);
            }
    }
  },
...
$$.GameTimer = {"": "Object;gameTime=,wallLastTimestamp,fps>,fpsSampleRate,timeDecrease<",
  tick$0: function() {
    ...
    t2 = this.gameTime;
    if (t1 !== true)
      this.gameTime = $.$$add(t2, gameDelta);
    else
      this.gameTime = $.$$sub(t2, gameDelta);
    return gameDelta;
  }
};
...
$$.GameEntity = {"": "Object;game>,isHighlighted>,soundReady=,id=,groupId>,box>,_removeFromGame>,radius>,momentum>,enabled=,opacity=,color>,fill>",
  ...
  GameEntity$withPosition$7: function(game, x, y, width, height, id, groupId) {
    ...
    if (t1 == null || $.$$eq($.length(t1), 0) === true)
      this.id = $.toString(this.get$hashCode());
  }
};
...
$$.Rectangle = {"": "Object;top=,left=,right=,bottom=",
  ...
  contains$1: function(point) {
    if (point == null)
      return false;
    return $.$$ge(point.get$x(), this.left) === true && $.$$le(point.get$x(), this.right) === true && $.$$ge(point.get$y(), this.top) === true && $.$$le(point.get$y(), this.bottom) === true;
  },
  get$width: function() {
...
$$.Momentum = {"": "Object;xVel=,yVel=,xAccel,yAccel,xMax,yMax",
  update$1: function(clockTick) {
    var t1, t2, t3, t4;
    t1 = this.xAccel;
    if (!(t1 == null) && $.$$eq(t1, 0) !== true && $.CONSTANT14.$lt($.abs(this.xVel), this.xMax)) {
      t2 = $.$$gt(this.xVel, 0);
      t3 = $.getInterceptor$JSNumber(t1);
      t4 = this.xVel;
      if (t2 === true)
        this.xVel = $.$$add(t4, t3.$mul(t1, clockTick));
      else
        this.xVel = $.$$sub(t4, t3.$mul(t1, clockTick));
    }
    t1 = this.yAccel;
    if (!(t1 == null) && $.$$eq(t1, 0) !== true && $.CONSTANT14.$lt($.abs(this.yVel), this.yMax)) {
      t2 = $.$$gt(this.yVel, 0);
      t3 = $.getInterceptor$JSNumber(t1);
      t4 = this.yVel;
      if (t2 === true)
        this.yVel = $.$$add(t4, t3.$mul(t1, clockTick));
      else
        this.yVel = $.$$sub(t4, t3.$mul(t1, clockTick));
    }
    t1 = this.xVel;
    if (!(t1 == null)) {
      t2 = this.xMax;
      t1 = !(t2 == null) && $.CONSTANT14.$gt($.abs(t1), t2);
    } else
      t1 = false;
    if (t1) {
      t1 = $.$$gt(this.xVel, 0);
      t2 = this.xMax;
      this.xVel = t1 === true ? t2 : $.$$negate(t2);
    }
    t1 = this.yVel;
    if (!(t1 == null)) {
      t2 = this.yMax;
    ...
    if (t1) {
      t1 = $.$$gt(this.yVel, 0);
      t2 = this.yMax;
      this.yVel = t1 === true ? t2 : $.$$negate(t2);
    }
  }
};
...
$$.GameButton = {"": "GameText;buttonAction,text,centered,font,size,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  ...
  update$0: function() {
    ...
    if (!(t1 == null)) {
      ...
      $.Primitives_printString($.toString($.contains(this.box, this.game.get$input().get$click())));
    }
    t1 = this.game.get$input().get$mouse();
    if (!(t1 == null) && $.contains(this.box, t1) === true) {
...
$$.GalagaRenderer = {"": "CanvasGameRenderer;timeLeft,powerUpRenderer,enemyRenderer,targetId,ctx,defaultRenderer,assetManager,textRenderer,_game,rect",
  init$0: function() {
    ...
    $.$$indexSet(t1, "killed", window.localStorage.containsKey$1("win1") === true ? $.int_parse(window.localStorage.$index("win1"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "wins", window.localStorage.containsKey$1("win2") === true ? $.int_parse(window.localStorage.$index("win2"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "loses", window.localStorage.containsKey$1("win3") === true ? $.int_parse(window.localStorage.$index("win3"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "totalGames", window.localStorage.containsKey$1("win4") === true ? $.int_parse(window.localStorage.$index("win4"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "highscore", window.localStorage.containsKey$1("win5") === true ? $.int_parse(window.localStorage.$index("win5"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "normalKills", window.localStorage.containsKey$1("win12") === true ? $.int_parse(window.localStorage.$index("win12"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "bossKills", window.localStorage.containsKey$1("win13") === true ? $.int_parse(window.localStorage.$index("win13"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "motherKills", window.localStorage.containsKey$1("win14") === true ? $.int_parse(window.localStorage.$index("win14"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    $.$$indexSet(t1, "powerups", window.localStorage.containsKey$1("win15") === true ? $.int_parse(window.localStorage.$index("win15"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "startLives", window.localStorage.containsKey$1("win6") === true ? $.int_parse(window.localStorage.$index("win6"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "bulletCap", window.localStorage.containsKey$1("win7") === true ? $.int_parse(window.localStorage.$index("win7"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "time", window.localStorage.containsKey$1("win8") === true ? $.int_parse(window.localStorage.$index("win8"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "difficulty", window.localStorage.containsKey$1("win9") === true ? $.int_parse(window.localStorage.$index("win9"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "powerups", window.localStorage.containsKey$1("win10") === true ? $.int_parse(window.localStorage.$index("win10"), null, null) : 0);
    t1 = this.get$game().get$Options();
    $.$$indexSet(t1, "soundeffects", window.localStorage.containsKey$1("win11") === true ? $.int_parse(window.localStorage.$index("win11"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 1, window.localStorage.containsKey$1("win16") === true ? $.int_parse(window.localStorage.$index("win16"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 2, window.localStorage.containsKey$1("win17") === true ? $.int_parse(window.localStorage.$index("win17"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 3, window.localStorage.containsKey$1("win18") === true ? $.int_parse(window.localStorage.$index("win18"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 4, window.localStorage.containsKey$1("win19") === true ? $.int_parse(window.localStorage.$index("win19"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 5, window.localStorage.containsKey$1("win20") === true ? $.int_parse(window.localStorage.$index("win20"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 6, window.localStorage.containsKey$1("win21") === true ? $.int_parse(window.localStorage.$index("win21"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 7, window.localStorage.containsKey$1("win22") === true ? $.int_parse(window.localStorage.$index("win22"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 8, window.localStorage.containsKey$1("win23") === true ? $.int_parse(window.localStorage.$index("win23"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 9, window.localStorage.containsKey$1("win24") === true ? $.int_parse(window.localStorage.$index("win24"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    $.$$indexSet(t1, 10, window.localStorage.containsKey$1("win25") === true ? $.int_parse(window.localStorage.$index("win25"), null, null) : 0);
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 1, window.localStorage.containsKey$1("win26") === true && $.int_parse(window.localStorage.$index("win26"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 2, window.localStorage.containsKey$1("win27") === true && $.int_parse(window.localStorage.$index("win27"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 3, window.localStorage.containsKey$1("win28") === true && $.int_parse(window.localStorage.$index("win28"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 4, window.localStorage.containsKey$1("win29") === true && $.int_parse(window.localStorage.$index("win29"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 5, window.localStorage.containsKey$1("win30") === true && $.int_parse(window.localStorage.$index("win30"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 6, window.localStorage.containsKey$1("win31") === true && $.int_parse(window.localStorage.$index("win31"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 7, window.localStorage.containsKey$1("win32") === true && $.int_parse(window.localStorage.$index("win32"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 8, window.localStorage.containsKey$1("win33") === true && $.int_parse(window.localStorage.$index("win33"), null, null));
    t1 = this.get$game().get$RankSelect();
    $.$$indexSet(t1, 9, window.localStorage.containsKey$1("win34") === true && $.int_parse(window.localStorage.$index("win34"), null, null));
  ...
  updateStats$0: function() {
    window.localStorage.$indexSet("win1", $.toString($.$$index(this.get$game().get$Stats(), "killed")));
    window.localStorage.$indexSet("win2", $.toString($.$$index(this.get$game().get$Stats(), "wins")));
    window.localStorage.$indexSet("win3", $.toString($.$$index(this.get$game().get$Stats(), "loses")));
    window.localStorage.$indexSet("win4", $.toString($.$$index(this.get$game().get$Stats(), "totalGames")));
    window.localStorage.$indexSet("win5", $.toString($.$$index(this.get$game().get$Stats(), "highscore")));
    window.localStorage.$indexSet("win12", $.toString($.$$index(this.get$game().get$Stats(), "normalKills")));
    window.localStorage.$indexSet("win13", $.toString($.$$index(this.get$game().get$Stats(), "bossKills")));
    window.localStorage.$indexSet("win14", $.toString($.$$index(this.get$game().get$Stats(), "motherKills")));
    window.localStorage.$indexSet("win15", $.toString($.$$index(this.get$game().get$Stats(), "powerups")));
    window.localStorage.$indexSet("win6", $.toString($.$$index(this.get$game().get$Options(), "startLives")));
    window.localStorage.$indexSet("win7", $.toString($.$$index(this.get$game().get$Options(), "bulletCap")));
    window.localStorage.$indexSet("win8", $.toString($.$$index(this.get$game().get$Options(), "time")));
    window.localStorage.$indexSet("win9", $.toString($.$$index(this.get$game().get$Options(), "difficulty")));
    window.localStorage.$indexSet("win10", $.toString($.$$index(this.get$game().get$Options(), "powerups")));
    window.localStorage.$indexSet("win11", $.toString($.$$index(this.get$game().get$Options(), "soundeffects")));
    window.localStorage.$indexSet("win16", $.toString($.$$index(this.get$game().get$Highscores(), 1)));
    window.localStorage.$indexSet("win17", $.toString($.$$index(this.get$game().get$Highscores(), 2)));
    window.localStorage.$indexSet("win18", $.toString($.$$index(this.get$game().get$Highscores(), 3)));
    window.localStorage.$indexSet("win19", $.toString($.$$index(this.get$game().get$Highscores(), 4)));
    window.localStorage.$indexSet("win20", $.toString($.$$index(this.get$game().get$Highscores(), 5)));
    window.localStorage.$indexSet("win21", $.toString($.$$index(this.get$game().get$Highscores(), 6)));
    window.localStorage.$indexSet("win22", $.toString($.$$index(this.get$game().get$Highscores(), 7)));
    window.localStorage.$indexSet("win23", $.toString($.$$index(this.get$game().get$Highscores(), 8)));
    window.localStorage.$indexSet("win24", $.toString($.$$index(this.get$game().get$Highscores(), 9)));
    window.localStorage.$indexSet("win25", $.toString($.$$index(this.get$game().get$Highscores(), 10)));
    window.localStorage.$indexSet("win26", $.toString($.$$index(this.get$game().get$RankSelect(), 1)));
    window.localStorage.$indexSet("win27", $.toString($.$$index(this.get$game().get$RankSelect(), 2)));
    window.localStorage.$indexSet("win28", $.toString($.$$index(this.get$game().get$RankSelect(), 3)));
    window.localStorage.$indexSet("win29", $.toString($.$$index(this.get$game().get$RankSelect(), 4)));
    window.localStorage.$indexSet("win30", $.toString($.$$index(this.get$game().get$RankSelect(), 5)));
    window.localStorage.$indexSet("win31", $.toString($.$$index(this.get$game().get$RankSelect(), 6)));
    window.localStorage.$indexSet("win32", $.toString($.$$index(this.get$game().get$RankSelect(), 7)));
    window.localStorage.$indexSet("win33", $.toString($.$$index(this.get$game().get$RankSelect(), 8)));
    window.localStorage.$indexSet("win34", $.toString($.$$index(this.get$game().get$RankSelect(), 9)));
  },
  bossHit$0: function() {
    $.forEach($.where(this.get$game().get$entities(), new $.GalagaRenderer_bossHit_anon()), new $.GalagaRenderer_bossHit_anon0(this));
  },
  motherShipHit$0: function() {
    $.forEach($.where(this.get$game().get$entities(), new $.GalagaRenderer_motherShipHit_anon()), new $.GalagaRenderer_motherShipHit_anon0(this));
  },
  normalShipHit$0: function() {
    $.forEach($.where(this.get$game().get$entities(), new $.GalagaRenderer_normalShipHit_anon()), new $.GalagaRenderer_normalShipHit_anon0(this));
  },
  ...
  drawBeforeCtxRestore$0: function() {
    if ($.$$eq(this.get$game().get$state(), 3) === true || $.$$eq(this.get$game().get$state(), 2) === true) {
      this.drawTime$0();
      this.drawScore$0();
  ...
  drawLevel$0: function() {
    ...
    this.ctx.fillText$3("Level: " + $.S(this.get$game().get$level()), 375, $.$$sub(this.get$game().get$rect().get$halfHeight(), 5));
  },
  drawTime$0: function() {
    this.ctx.set$fillStyle("rgba(255, 255, 255, 1)");
    this.ctx.set$font("32px cinnamoncake, Verdana");
    this.ctx.fillText$3("Time: " + $.S($.round(this.get$game().get$timer().get$gameTime())) + " ", -100, $.$$negate($.$$sub(this.get$game().get$rect().get$halfHeight(), 30)));
  },
  drawLives$0: function() {
    this.ctx.set$fillStyle("rgba(255, 255, 255, 1)");
    this.ctx.set$font("32px cinnamoncake, Verdana");
    this.ctx.fillText$3("Lives: " + $.S(this.get$game().get$ship().get$lives()) + " ", -475, $.$$sub(this.get$game().get$rect().get$halfHeight(), 5));
  },
  drawScore$0: function() {
    this.ctx.set$fillStyle("rgba(255, 255, 255, 1)");
    this.ctx.set$font("32px cinnamoncake, Verdana");
    this.ctx.fillText$3("Score: " + $.S(this.get$game().get$score()) + " ", -475, $.$$negate($.$$sub(this.get$game().get$rect().get$halfHeight(), 30)));
  },
  drawHighScore$0: function() {
    this.ctx.set$fillStyle("rgba(255, 255, 255, 1)");
    this.ctx.set$font("32px cinnamoncake, Verdana");
    this.ctx.fillText$3("High Score: " + $.S($.$$index(this.get$game().get$Stats(), "highscore")) + " ", 225, $.$$negate($.$$sub(this.get$game().get$rect().get$halfHeight(), 30)));
  },
  bgFade$0: function() {
  ...
  render$1: function(e) {
    ...
    switch (e.get$type()) {
      case "SpiralShot":
        ...
        break;
      case "Multiplier":
        t1.get$ctx().fillText$3("x2", $.$$sub(e.get$x(), 12), $.$$add(e.get$y(), 8));
        break;
      case "BulletIncrease":
        t1.get$ctx().set$font("36px Verdana");
        t1.get$ctx().fillText$3("+", $.$$sub(e.get$x(), 14), $.$$add(e.get$y(), 10));
        break;
      case "ExtraLife":
        t1.get$ctx().set$font("12px Verdana");
        t1.get$ctx().fillText$3("Life", $.$$sub(e.get$x(), 10), $.$$add(e.get$y(), 8));
        break;
    }
  }
};
...
$$.EnemyRenderer = {"": "DefaultCanvasEntityRenderer;gr",
  render$1: function(e) {
    ...
    switch (e.get$type()) {
      case "Boss":
        t1.get$ctx().fillText$3($.S(e.get$health()), $.$$sub(e.get$x(), 8), $.$$add(e.get$y(), 8));
        break;
    }
  }
};
...
$$.CanvasGameRenderer = {"": "GameRenderer;targetId=,ctx>",
  ...
  render$0: function() {
    ...
    for (t1 = $.iterator(this.get$game().get$entities()); t1.moveNext$0() === true;) {
      t2 = t1.get$current();
  ...
  drawDebugInfo$0: function() {
    ...
    this.ctx.fillText$3("FPS: " + $.S($.toStringAsFixed(this.get$game().get$timer().get$fps(), 1)), $.$$sub(this.rect.get$halfWidth(), 120), $.$$negate($.$$sub(this.rect.get$halfHeight(), 30)));
  },
...
$$.HtmlGameInput_start_anon1 = {"": "Closure;this_5,getXandY_6",
  call$1: function(e) {
    var t1;
    e.preventDefault$0();
    t1 = this.getXandY_6.call$1($.$$index(e.get$touches(), 0));
  ...
  call$1$bailout: function(state0, value, t1, t3, $length) {
    switch (state0) {
      ...
      case 2:
        var i, t2;
        state0 = 0;
        for (i = 0; $.CONSTANT16.$lt(i, $length); ++i) {
          t2 = t3.$index(t1, i);
          if (t2 == null ? value == null : t2 === value)
            return i;
        }
...
$$.convertNativeToDart_AcceptStructuredClone_walk = {"": "Closure;mustCopy_4,findSlot_5,readSlot_6,writeSlot_7",
  call$1: function(e) {
    ...
    if (Object.getPrototypeOf(e) === Object.prototype) {
      ...
      for (t1 = $.CONSTANT10.get$iterator(Object.keys(e)); t1.moveNext$0() === true;) {
        t2 = t1.get$current();
    ...
    if (e instanceof Array) {
      ...
      if (typeof copy !== "object" || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.$isJavaScriptIndexingBehavior())
        return this.call$1$bailout(3, e, $length, $.CONSTANT10, slot, copy);
      this.writeSlot_7.call$2(slot, copy);
      for (i = 0; i < $length; ++i) {
        if (i >= e.length)
          throw $.ioore(i);
        ...
        if (state0 === 3 || state0 === 2 || state0 === 0 && e instanceof Array)
          switch (state0) {
            ...
            case 3:
              state0 = 0;
              this.writeSlot_7.call$2(slot, copy);
              for (t2 = $.getInterceptor$JSArray(copy), i = 0; $.CONSTANT16.$lt(i, $length); ++i)
...
$$.GalagaGame_update_anon6 = {"": "Closure;this_0",
  call$1: function(e) {
    var t1;
    if ($.$$eq(e.get$opacity(), 1) === true && e.get$isHighlighted() === true && e.get$soundReady() === true) {
      t1 = this.this_0;
      if (t1.get$soundEffectsOn() === true)
        t1.get$sound().play$3("cursorMove", 1, false);
      e.set$soundReady(false);
    } else if ($.$$lt(e.get$opacity(), 1) === true)
...
$$.Bullet_update_anon = {"": "Closure;this_0",
  call$1: function(t) {
    var t1 = this.this_0;
    t1.set$_waiting($.$$add(t1.get$_waiting(), 1));
    if ($.$$eq(t1.get$_waiting(), 1) === true) {
      t1.get$game().newMiniExplosion$2(t1.get$x(), t1.get$y());
      t1.get$game().addEntity$1($.Bullet$(t1.get$game(), t1.get$x(), $.$$add(t1.get$y(), 16), "straight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
      t1.get$game().addEntity$1($.Bullet$(t1.get$game(), t1.get$x(), $.$$add(t1.get$y(), 16), "left", $.random(350, 400, false), $.random(8, 16, false), "normal"));
      t1.get$game().addEntity$1($.Bullet$(t1.get$game(), t1.get$x(), $.$$add(t1.get$y(), 16), "right", $.random(350, 400, false), $.random(8, 16, false), "normal"));
      t1.get$game().addEntity$1($.Bullet$(t1.get$game(), t1.get$x(), $.$$add(t1.get$y(), 16), "farLeft", $.random(350, 400, false), $.random(8, 16, false), "normal"));
      t1.get$game().addEntity$1($.Bullet$(t1.get$game(), t1.get$x(), $.$$add(t1.get$y(), 16), "farRight", $.random(350, 400, false), $.random(8, 16, false), "normal"));
      t1.removeFromGame$0();
      t.cancel$0();
    }
  },
...
$$.Bullet_update_anon1 = {"": "Closure;this_2",
  call$1: function(e) {
    var t1 = this.this_2;
    if ($.$$gt(t1.get$width(), e.get$width()) === true && $.$$gt(t1.get$height(), e.get$height()) === true && $.$$eq(e.get$x(), t1.get$x()) !== true && $.$$eq(e.get$y(), t1.get$y()) !== true) {
...
$$.Bullet_update_anon3 = {"": "Closure;this_4",
  call$1: function(enemy) {
    var t1, t2;
    t1 = this.this_4;
    if ($.$$gt(t1.get$width(), enemy.get$width()) === true && $.$$gt(t1.get$height(), enemy.get$height()) === true) {
      t1.set$width($.$$sub(t1.get$width(), enemy.get$width()));
      t1.set$height($.$$sub(t1.get$height(), enemy.get$height()));
    } else
      t1.removeFromGame$0();
    t2 = enemy.get$idNum();
    t1.get$game().set$targetId(t2);
    if ($.$$lt(t1.get$game().get$ship().get$bullet(), 3) === true) {
    ...
    if ($.$$eq(enemy.get$type(), "MotherShip") === true)
      t1.get$game().get$_motherShipEvent().signal$0();
    else if ($.$$eq(enemy.get$type(), "Boss") === true)
      t1.get$game().get$_bossHitEvent().signal$0();
    else if ($.$$eq(enemy.get$type(), "Normal") === true)
      t1.get$game().get$_normalHitEvent().signal$0();
    if ($.$$eq(enemy.get$type(), "Boss") !== true) {
      enemy.set$width($.$$sub(enemy.get$width(), 8));
      enemy.set$height($.$$sub(enemy.get$height(), 8));
    }
    enemy.set$health($.$$sub(enemy.get$health(), 1));
  }
};
...
$$.Bullet_update_anon5 = {"": "Closure;this_6",
  call$1: function(e) {
    ...
    t1 = this.this_6;
    t2 = t1.get$game().get$ship();
    t2.set$lives($.$$sub(t2.get$lives(), 1));
...
$$.GalagaGame_switchDirection_anon0 = {"": "Closure;",
  call$1: function(e) {
    var t1;
    if ($.$$eq(e.get$type(), "Normal") === true) {
      t1 = e.get$momentum();
      t1.set$xVel($.$$mul(t1.get$xVel(), -1));
      if ($.$$ge(e.get$momentum().get$xVel(), 0) === true)
        e.set$x($.$$add(e.get$x(), 3));
      else
        e.set$x($.$$sub(e.get$x(), 3));
    }
  }
};
...
$$.GalagaGame_canEnemyFall_anon0 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1;
    if ($.$$eq(e.get$type(), "Normal") === true && $.$$eq(e.get$isFalling(), true) === true) {
      t1 = this.box_0;
      t1.x_0 = $.$$add(t1.x_0, 1);
    }
  }
...
$$.GalagaGame_newBossDrone_anon0 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1;
    if ($.$$eq($.propertyTypeCast(e, "$isEnemy").type, "Drone") === true) {
      t1 = this.box_0;
      t1.x_0 = $.$$add(t1.x_0, 1);
    }
  },
...
$$.GalagaGame_getEnemyY_anon0 = {"": "Closure;type_0",
  call$1: function(e) {
    if ($.$$eq(e.get$type(), this.type_0) === true && $.$$eq(e.get$isFalling(), true) === true)
      return e.get$y();
  }
};
...
$$.GalagaGame_newMotherShip_anon0 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1;
    if ($.$$eq(e.get$type(), "MotherShip") === true) {
      t1 = this.box_0;
      t1.x_0 = $.$$add(t1.x_0, 1);
    }
  }
...
$$.GalagaGame_waiting_anon = {"": "Closure;this_0",
  call$1: function(t) {
    ...
    t1 = this.this_0;
    t1.set$_waiting($.$$add(t1.get$_waiting(), 1));
    if ($.$$eq(t1.get$_waiting(), 3) === true) {
      $.forEach($.toList($.where(t1.get$entities(), new $.GalagaGame_waiting__anon())), new $.GalagaGame_waiting__anon0());
      for (i = 0; i < 50; ++i) {
        if ($.$$lt(t1.get$colorCount(), 7) === true)
          t1.set$colorCount($.$$add(t1.get$colorCount(), 1));
        else if ($.$$ge(t1.get$colorCount(), 7) === true)
          t1.set$colorCount(1);
        t1.startStars$0();
      }
      t1.set$enemyX(-400);
      ...
      if ($.$$lt(t1.get$difficulty(), 5) === true)
        t1.set$difficulty($.$$add(t1.get$difficulty(), 1));
      if ($.$$ge(t1.get$visualLevel(), t1.get$bonusCheck()) === true) {
        t1.set$bonusStage(true);
        t1.set$tutorial(false);
        t1.set$bonusCheck($.$$add(t1.get$bonusCheck(), 3));
      } else
        t1.set$bonusStage(false);
      if ($.$$eq(t1.get$bonusStage(), true) === true)
        t1.newBoss$0();
      else
        for (i = 0; i < 33; ++i)
...
$$.GalagaGame_createOptionsMenu_anon = {"": "Closure;this_0",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.$$ge($.$$index(t1.get$Options(), "startLives"), 10);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "startLives", 1);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "startLives", $.$$add(t2.$index(t3, "startLives"), 1));
    }
    t1.get$_statUpdateEvent().signal$0();
    t1.set$state(1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon0 = {"": "Closure;this_1",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_1;
    t2 = $.$$ge($.$$index(t1.get$Options(), "bulletCap"), 10);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "bulletCap", 1);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "bulletCap", $.$$add(t2.$index(t3, "bulletCap"), 1));
    }
    t1.get$_statUpdateEvent().signal$0();
    t1.set$state(1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon1 = {"": "Closure;this_2",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_2;
    t2 = $.$$ge($.$$index(t1.get$Options(), "time"), 180);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "time", 0);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "time", $.$$add(t2.$index(t3, "time"), 20));
    }
    t1.get$_statUpdateEvent().signal$0();
    t1.set$state(1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon2 = {"": "Closure;this_3",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_3;
    t2 = $.$$ge($.$$index(t1.get$Options(), "difficulty"), 5);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "difficulty", 1);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "difficulty", $.$$add(t2.$index(t3, "difficulty"), 1));
    }
    t1.get$_statUpdateEvent().signal$0();
    t1.set$state(1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon3 = {"": "Closure;this_4",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_4;
    t2 = $.$$ge($.$$index(t1.get$Options(), "powerups"), 2);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "powerups", 1);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "powerups", $.$$add(t2.$index(t3, "powerups"), 1));
    }
    t1.get$_statUpdateEvent().signal$0();
    t1.set$state(1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon4 = {"": "Closure;this_5",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.this_5;
    t2 = $.$$ge($.$$index(t1.get$Options(), "soundeffects"), 2);
    t3 = t1.get$Options();
    if (t2 === true)
      $.$$indexSet(t3, "soundeffects", 1);
    else {
      t2 = $.getInterceptor$JSArrayJSString(t3);
      t2.$indexSet(t3, "soundeffects", $.$$add(t2.$index(t3, "soundeffects"), 1));
    }
    if ($.$$eq($.$$index(t1.get$Options(), "soundeffects"), 1) === true)
...
$$.GalagaRenderer_normalShipHit_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    if ($.$$eq(e.get$type(), "Normal") === true && $.$$eq(e.get$idNum(), this.this_0.get$game().get$targetId()) === true) {
...
$$.GalagaRenderer_bossHit_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    if ($.$$eq(e.get$type(), "Boss") === true && $.$$eq(e.get$idNum(), this.this_0.get$game().get$targetId()) === true) {
...
$$.GalagaRenderer_motherShipHit_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    if ($.$$eq(e.get$type(), "MotherShip") === true && $.$$eq(e.get$idNum(), this.this_0.get$game().get$targetId()) === true) {
...
$.unwrapException = function(ex) {
  ...
  if (ex instanceof TypeError) {
    ...
    if (t1)
      if ($.CONSTANT9.endsWith$1(message, "is null") === true || $.CONSTANT9.endsWith$1(message, "is undefined") === true || $.CONSTANT9.endsWith$1(message, "is null or undefined") === true || $.CONSTANT9.endsWith$1(message, "of undefined") === true || $.CONSTANT9.endsWith$1(message, "of null") === true)
...
$.makeLiteralMap = function(keyValuePairs) {
  ...
  iterator = $.CONSTANT10.get$iterator(keyValuePairs);
...
$.stringContainsUnchecked = function(receiver, other, startIndex) {
  if (typeof other === "string")
    return $.$$eq($.CONSTANT9.indexOf$2(receiver, other, startIndex), -1) !== true;
    ...
    return $.iterator($.allMatches(other, $.CONSTANT9.substring$1(receiver, startIndex))).moveNext$0();
};
...
$.Arrays_copy$bailout = function(state0, src, srcStart, dst, dstStart, count) {
  ...
  if (srcStart < dstStart)
    for (i = srcStart + count - 1, j = dstStart + count - 1, t1 = $.getInterceptor$JSArrayJSString(src); i >= srcStart; --i, --j)
      $.CONSTANT10.$indexSet(dst, j, t1.$index(src, i));
  else
...
$.IterableMixinWorkaround_joinList$bailout = function(state0, list, separator) {
  ...
  buffer = $.StringBuffer$("");
  if (separator == null || $.$$eq(separator, "") === true)
    for (i = 0; $.CONSTANT16.$lt(i, t1.get$length(list)); ++i)
      buffer.add$1($.S(t1.$index(list, i)));
  else {
    buffer.add$1($.S(t1.$index(list, 0)));
    for (i = 1; $.CONSTANT16.$lt(i, t1.get$length(list)); ++i) {
      buffer.add$1(separator);
      buffer.add$1($.S(t1.$index(list, i)));
    }
  }
...
$.Error_safeToString = function(object) {
  ...
  if (typeof object === "string")
    return "\"" + $.S($.replaceAll($.replaceAll($.replaceAll($.CONSTANT9.replaceAll$2(object, "\\", "\\\\"), "\n", "\\n"), "\r", "\\r"), "\"", "\\\"")) + "\"";
...
$.List_List$fixedLength$bailout = function(state0, $length, fill, result) {
  var t1, i;
  if ($.$$eq($length, 0) !== true && !(fill == null))
    for (t1 = $.getInterceptor$JSArrayJSString(result), i = 0; $.CONSTANT16.$lt(i, t1.get$length(result)); ++i)
...
$.min = function(a, b) {
  ...
  if (typeof a === "number")
    if (a === 0)
      return (a + b) * a * b;
  if (a === 0 && $.CONSTANT32.get$isNegative(b) === true || $.CONSTANT32.get$isNaN(b) === true)
    return b;
  return a;
  return a;
...
$.Rectangle_intersect = function(r1, r2) {
  return !($.$$gt(r1.left, r2.get$right()) === true || $.$$lt(r1.right, r2.get$left()) === true || $.$$gt(r1.top, r2.get$bottom()) === true || $.$$lt(r1.bottom, r2.get$top()) === true);
};
...
$.CONSTANT27 = new Isolate.$isolateProperties.Duration(225);
$.CONSTANT33 = new Isolate.$isolateProperties.Object();
$.CONSTANT20 = new Isolate.$isolateProperties.Duration(25);
$.CONSTANT6 = new Isolate.$isolateProperties.EventStreamProvider("mousemove");
$.CONSTANT1 = new Isolate.$isolateProperties.EventStreamProvider("mouseup");
$.CONSTANT15 = new Isolate.$isolateProperties._LinkedHashTableHeadMarker();
$.CONSTANT24 = new Isolate.$isolateProperties.Duration(150);
$.CONSTANT28 = new Isolate.$isolateProperties.Duration(275);
$.CONSTANT21 = new Isolate.$isolateProperties.Duration(75);
$.CONSTANT17 = new Isolate.$isolateProperties._Random();
$.CONSTANT26 = new Isolate.$isolateProperties.Duration(200);
$.CONSTANT4 = new Isolate.$isolateProperties.EventStreamProvider("touchstart");
$.CONSTANT8 = new Isolate.$isolateProperties.Duration(0);
$.CONSTANT7 = new Isolate.$isolateProperties.EventStreamProvider("click");
$.CONSTANT13 = new Isolate.$isolateProperties.JSNull();
$.CONSTANT10 = new Isolate.$isolateProperties.JSArray();
$.CONSTANT = new Isolate.$isolateProperties.NullThrownError();
$.CONSTANT14 = new Isolate.$isolateProperties.JSNumber();
$.CONSTANT2 = new Isolate.$isolateProperties.EventStreamProvider("mousedown");
$.CONSTANT9 = new Isolate.$isolateProperties.JSString();
$.CONSTANT16 = new Isolate.$isolateProperties.JSInt();
$.CONSTANT31 = new Isolate.$isolateProperties.Duration(375);
$.CONSTANT5 = new Isolate.$isolateProperties.EventStreamProvider("touchmove");
$.CONSTANT23 = new Isolate.$isolateProperties.Duration(125);
$.CONSTANT0 = new Isolate.$isolateProperties.Duration(50);
$.CONSTANT35 = new Isolate.$isolateProperties._DelayedDone();
$.CONSTANT18 = new Isolate.$isolateProperties.Duration(250);
$.CONSTANT25 = new Isolate.$isolateProperties.Duration(175);
$.CONSTANT29 = new Isolate.$isolateProperties.EventStreamProvider("ended");
$.CONSTANT30 = new Isolate.$isolateProperties.Duration(300);
$.CONSTANT32 = new Isolate.$isolateProperties.JSDouble();
$.CONSTANT19 = new Isolate.$isolateProperties.Duration(1000);
$.CONSTANT22 = new Isolate.$isolateProperties.Duration(100);
$.CONSTANT11 = new Isolate.$isolateProperties._DeadEntry();
$.CONSTANT12 = new Isolate.$isolateProperties._NullKey();
$.CONSTANT3 = new Isolate.$isolateProperties.EventStreamProvider("keydown");
$.lazyPort = null;
...
$.$defineNativeClass("Document", {"": "$$dom_body:body~",
  ...
  query$1: function(selectors) {
    if ($.RegExp_RegExp("^#[_a-zA-Z]\\w*$", true, false).hasMatch$1(selectors))
      return this.$$dom_getElementById$1($.CONSTANT9.substring$1(selectors, 1));
